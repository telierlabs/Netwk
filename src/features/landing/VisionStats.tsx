  ...
  return (
    <section style={{ 
      ...
      <div className="stat-container">
        ...
        <div className="stat-label">frontier AI models integrated</div>
      </div>
      ...
      <div className="stat-container">
        ...
        <div className="stat-label">context switching required</div>
      </div>
      ...
      <div className="stat-container">
        ...
        <div className="stat-label">mission for the future of working with AI</div>
      </div>

...
// Komponen buat list Q&A biar gampang
const QaRow: React.FC<{ question: string }> = ({ question }) => (
  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '24px 0', borderBottom: '1px solid rgba(255,255,255,0.05)', cursor: 'pointer' }}>
    <span style={{ fontSize: '15px', color: '#fff', fontWeight: 500 }}>{question}</span>
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
  </div>
);
      ...
      <main style={{ flex: 1, padding: '60px 24px 100px', maxWidth: '700px', margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ marginBottom: '100px' }}>
          ...
          <div style={{ background: '#111', borderRadius: '20px', padding: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
             <div style={{ width: '100%', height: '180px', background: '#222', borderRadius: '12px', marginBottom: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#555', fontSize: '13px' }}>[ Architectural Diagram Uploaded ]</div>
             <div style={{ fontSize: '14px', color: '#ccc', padding: '0 8px' }}>
               Based on the uploaded diagram, the bottleneck is occurring at the API gateway layer where the rate limit is capped at 100 req/s...
             </div>
          </div>
        </div>
        ...
        <div style={{ marginBottom: '100px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div style={{ background: '#111', borderRadius: '16px', height: '200px', border: '1px solid rgba(255,255,255,0.05)', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ background: '#111', borderRadius: '16px', height: '200px', border: '1px solid rgba(255,255,255,0.05)', position: 'relative', overflow: 'hidden' }}>
               ...
               <div style={{ width: '100%', height: '100%', background: 'linear-gradient(135deg, #2c3e50, #2980b9)' }}></div>
            </div>
          </div>
        ...
        {/* CLOUD FUNDING MISSION (PENGGANTI QUOTE) */}
        <div style={{ padding: '60px 0', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', marginBottom: '100px', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '14px', color: '#666', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
             ...
             Telierlabs Infrastructure Mission
          </div>
        </div>
        ...
        <div style={{ marginBottom: '80px' }}>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
            <QaRow question="What image understanding capabilities does Cylen support?" />
            <QaRow question="When will text-to-image and text-to-video be available?" />
            <QaRow question="Can I edit existing images and videos with text prompts?" />
            <QaRow question="What aspect ratios and resolutions will be supported?" />
            <QaRow question="How will pricing work for heavy GPU tasks like video generation?" />
            <QaRow question="Is content moderation applied to generated outputs?" />
          </div>
        </div>

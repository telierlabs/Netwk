...
// ✅ Tambah onViewDocs ke props interface
      ...
      <main style={{ flex: 1, padding: '60px 24px 100px', maxWidth: '700px', margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '100px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', marginBottom: '32px' }}>
            ...
            {/* ✅ onClick onViewDocs dipasang di sini */}
        ...
        {/* SECTION 1: VISION UNDERSTANDING */}
        ...
        {/* SECTION 3: CREATIVE RESTYLE & EDITS */}
        <div style={{ marginBottom: '100px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>

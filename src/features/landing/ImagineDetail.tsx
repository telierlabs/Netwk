...
// 👇 Komponen QaRow udah di-upgrade biar bisa diklik buka-tutup
const QaRow: React.FC<{ question: string; answer: string }> = ({ question, answer }) => {
  ...
  return (
    <div style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      {/* Isi jawaban bakal muncul kalau isOpen = true */}
      {isOpen && (
      ...
      <main style={{ flex: 1, padding: '60px 24px 100px', maxWidth: '700px', margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ marginBottom: '80px' }}>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
            {/* 👇 Ini Jawaban Q&A yang udah diisi jujur sesuai kondisi lu */}
            <QaRow 

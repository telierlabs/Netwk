...
export const DemoCards: React.FC = () => {
  return (
    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      {/* Card 1: Chat */}
      <div style={{ background: '#131313', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.04)', textAlign: 'left', overflow: 'hidden' }}>
        <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          <div style={{ background: 'transparent', padding: '12px 18px', borderRadius: '18px 18px 18px 0', alignSelf: 'flex-start', fontSize: '14px', color: '#fff', border: '1px solid rgba(255,255,255,0.08)', maxWidth: '90%' }}>
            Lubang hitam terbentuk ketika bintang masif kehabisan bahan bakar dan runtuh di bawah gravitasinya sendiri.
          </div>
        </div>
      ...
      {/* Card 2: Build (Code) */}
      <div style={{ background: '#0a0a0a', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.04)', textAlign: 'left', fontFamily: 'monospace', overflow: 'hidden' }}>
        <div style={{ padding: '24px' }}>
          ...
          <div style={{ fontSize: '13px', color: '#fff', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <div style={{ display: 'flex', opacity: 0.6 }}><span style={{ marginRight: '8px' }}>&gt;</span> Migrasi sesi auth ke JWT.</div>

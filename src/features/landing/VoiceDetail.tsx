      ...
      <main style={{ flex: 1, padding: '60px 24px 100px', maxWidth: '700px', margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ marginBottom: '100px' }}>
          ...
          <div style={{ background: '#111', borderRadius: '20px', padding: '40px 24px', border: '1px solid rgba(255,255,255,0.05)', textAlign: 'center' }}>
            <div style={{ width: '64px', height: '64px', background: 'rgba(255,255,255,0.1)', borderRadius: '50%', margin: '0 auto 24px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,255,255,0.2)' }}>
               <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"></path></svg>
            </div>
            <div style={{ fontSize: '15px', color: '#fff', marginBottom: '8px' }}>Listening...</div>
            <div style={{ fontSize: '13px', color: '#666' }}>"Explain how vector databases work in simple terms..."</div>
          </div>
        </div>
        ...
        <div style={{ marginBottom: '100px' }}>
          ...
          <div style={{ background: '#111', borderRadius: '20px', padding: '60px 24px', border: '1px solid rgba(255,255,255,0.05)', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px' }}>
             {/* Waveform Mockup statis yang elegan */}
             <div style={{ width: '4px', height: '16px', background: '#333', borderRadius: '4px' }}></div>
             <div style={{ width: '4px', height: '32px', background: '#444', borderRadius: '4px' }}></div>
             <div style={{ width: '4px', height: '48px', background: '#666', borderRadius: '4px' }}></div>
             <div style={{ width: '4px', height: '32px', background: '#444', borderRadius: '4px' }}></div>
             <div style={{ width: '4px', height: '16px', background: '#333', borderRadius: '4px' }}></div>
             <span style={{ fontSize: '13px', color: '#555', marginLeft: '12px' }}>Waiting for Cloud Compute...</span>
          </div>
        </div>
        ...
        <div style={{ padding: '60px 0', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', marginBottom: '100px', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '13px', color: '#f39c12', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', letterSpacing: '1px', textTransform: 'uppercase', fontWeight: 600 }}>
             Telierlabs Infrastructure Goal
          </div>
        </div>

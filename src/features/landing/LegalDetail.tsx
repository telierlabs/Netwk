      ...
      body: (
        <>
          <p style={{ marginBottom: '16px', lineHeight: 1.6 }}>
            {/* 👇 Diganti TelierNews */}
            Cylen is a unified artificial intelligence workspace developed by <strong>TelierNews</strong>. Founded by Muhamad Rivaldy, TelierNews operates from Cirebon, Indonesia, with a global mission to democratize access to frontier AI models.
          </p>
          <p style={{ marginBottom: '16px', lineHeight: 1.6 }}>
    ...
    terms: {
      ...
      body: (
        <>
          ...
          <p style={{ lineHeight: 1.6 }}>
            {/* 👇 Diganti TelierNews */}
            <strong>3. User Responsibility:</strong> You are solely responsible for the content you generate and code you execute using Cylen. TelierNews is not liable for any damages or code errors resulting from the use of our AI suggestions.
          </p>
        </>
      )
    },
      ...
      body: (
        <>
          <p style={{ marginBottom: '24px', lineHeight: 1.6 }}>
            Have a question, partnership proposal, or need technical support? We'd love to hear from you. Please reach out to our team via the email addresses below.
          </p>
          <div style={{ background: '#0a0a0a', padding: '24px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)', marginBottom: '16px' }}>
            <div style={{ color: '#fff', fontWeight: 500, marginBottom: '4px' }}>Business & General Inquiries</div>
            <a href="mailto:contact@teliernews.com" style={{ color: '#4CAF50', textDecoration: 'none', fontSize: '15px' }}>contact@teliernews.com</a>
          </div>
          <div style={{ background: '#0a0a0a', padding: '24px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
            <div style={{ color: '#fff', fontWeight: 500, marginBottom: '4px' }}>Technical Support & Admin</div>
            <a href="mailto:admin@teliernews.com" style={{ color: '#4CAF50', textDecoration: 'none', fontSize: '15px' }}>admin@teliernews.com</a>
          </div>
        </>
      )
    }

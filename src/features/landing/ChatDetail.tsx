      ...
      <main style={{ flex: 1, padding: '60px 24px 100px', maxWidth: '700px', margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ marginBottom: '120px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            ...
            {/* 10. Live Teliernews Integration (Ganti logo X ke T) */}
            <div style={{ display: 'flex', gap: '20px', opacity: 0.6 }}>
              {/* Logo T Custom Simple */}
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="1.5" style={{ marginTop: '4px' }}><line x1="12" y1="4" x2="12" y2="20"></line><line x1="4" y1="4" x2="20" y2="4"></line></svg>
              <div>
                <div style={{ fontSize: '16px', fontWeight: 500, color: '#fff', marginBottom: '6px' }}>

...
export const ChatDetail: React.FC<{ onBack: () => void, onLogin: () => void }> = ({ onBack, onLogin }) => {
  useEffect(() => { 
    // Paksa window scroll ke atas tiap kali komponen ini dipanggil
    window.scrollTo(0, 0); 
  }, []);

  return (
    // 👇 FIX BUG SCROLL: Tambahin height: '100dvh', overflowY: 'auto', dan overflowX: 'hidden' di sini
    <div style={{ 
      background: '#000', 
      minHeight: '100dvh',
      height: '100dvh', // Paksa tinggi
      width: '100vw', 
      color: '#fff', 
      fontFamily: "'Sora', sans-serif", 
      display: 'flex', 
      flexDirection: 'column',
      overflowY: 'auto', // Paksa izinkan scroll vertikal
      overflowX: 'hidden' // Kunci scroll horizontal biar ga goyang
    }}>

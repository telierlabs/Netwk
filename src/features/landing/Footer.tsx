        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '32px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '13px' }}>
              ...
              <a href="#" style={{ color: '#888', textDecoration: 'none' }}>API Documentation</a>
              <a href="#" style={{ color: '#888', textDecoration: 'none' }}>System Status</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '13px' }}>
              <a href="#" style={{ color: '#888', textDecoration: 'none' }}>About Us</a>

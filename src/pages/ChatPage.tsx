...
interface ChatPageProps {
  ...
  onRetry?: () => void;
  // Mode welcome desktop: input kecil di tengah, tanpa chat list
...
const EmptyState = () => (
  <div className="flex flex-col items-center justify-center flex-1">
    ...
    `}</style>
    <div className="flex items-center gap-4" style={{ animation: 'floatLogo 3.5s ease-in-out infinite' }}>
      ...
      <span className="text-[var(--text)] font-bold tracking-tight" style={{ fontSize: '2.4rem', lineHeight: 1 }}>
        Cylen
      </span>
    </div>
  </div>
...
export const ChatPage: React.FC<ChatPageProps> = ({
  ...
  // ── DESKTOP WELCOME MODE: hanya render input kecil ──
    ...
    return (
      <div style={{ width: '100%' }}>
        <ChatInput
          ...
          compact // prop baru untuk styling compact
        />
      </div>
    );
  }

...
const WebSearchLoading = ({ query }: { query: string }) => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%', marginTop: 8 }}>
      ...
      {/* Baris Atas: Ikon Bulan Sabit Cylen */}
      ...
      {/* Baris Bawah: Logo TelierNews & Query (Sejajar ke Kiri) */}
      {/* marginLeft: -3 dipakai agar center-nya pas dengan ikon bulan yang ukurannya 26px */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginLeft: -3 }}>

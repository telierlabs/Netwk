...
// UPDATE: Modifikasi Tampilan Utama Menjadi Besar, Elegan, Bermutu, dan Dilengkapi Animasi Orbit Partikel Adaptif
const EmptyState = () => (
  <div className="flex-1 flex flex-col items-center justify-center select-none pointer-events-none relative overflow-hidden" style={{ paddingBottom: '14vh' }}>
    {/* Mengimpor Font Montserrat langsung dari Google Fonts */}
    <style>{`
    ...
    <div className="relative w-[340px] h-[340px] flex items-center justify-center">
      {/* Ring Orbit 1: Searah jarum jam */}
      <div 
        style={{
          position: 'absolute', width: '100%', height: '100%',
          animation: 'particle-orbit-clockwise 25s linear infinite',
          border: '1px dashed var(--text)', opacity: 0.04, borderRadius: '50%'
        }} 
      />
      
      {/* Titik partikel di Ring 1 */}
      <div style={{ position: 'absolute', width: '100%', height: '100%', animation: 'particle-orbit-clockwise 18s linear infinite' }}>
        <div style={{ position: 'absolute', top: '15%', left: '15%', width: 5, height: 5, borderRadius: '50%', background: 'var(--text)', opacity: 0.25 }} />
        <div style={{ position: 'absolute', bottom: '20%', right: '10%', width: 4, height: 4, borderRadius: '50%', background: 'var(--text)', opacity: 0.2 }} />
        <div style={{ position: 'absolute', top: '80%', left: '25%', width: 5, height: 5, borderRadius: '50%', background: 'var(--text)', opacity: 0.15 }} />
      </div>

      {/* Ring Orbit 2: Berlawanan arah jarum jam */}
      <div style={{ position: 'absolute', width: '80%', height: '80%', animation: 'particle-orbit-counter 14s linear infinite' }}>
        <div style={{ position: 'absolute', top: '5%', right: '30%', width: 4, height: 4, borderRadius: '50%', background: 'var(--text)', opacity: 0.3 }} />
        <div style={{ position: 'absolute', bottom: '15%', left: '15%', width: 6, height: 6, borderRadius: '50%', background: 'var(--text)', opacity: 0.22 }} />
        <div style={{ position: 'absolute', top: '50%', right: '0%', width: 3, height: 3, borderRadius: '50%', background: 'var(--text)', opacity: 0.4 }} />
      </div>

      {/* Ring Orbit 3: Lapisan partikel terdalam */}
      <div style={{ position: 'absolute', width: '60%', height: '60%', animation: 'particle-orbit-clockwise 10s linear infinite' }}>
        <div style={{ position: 'absolute', top: '0%', left: '50%', width: 4, height: 4, borderRadius: '50%', background: 'var(--text)', opacity: 0.35 }} />
        <div style={{ position: 'absolute', bottom: '5%', right: '40%', width: 5, height: 5, borderRadius: '50%', background: 'var(--text)', opacity: 0.2 }} />
      </div>

      {/* Konten Teks Tengah Utama */}
      <h1 
        style={{
          ...
          textAlign: 'center',
          zIndex: 2,
          animation: 'text-pulse-subtle 4s ease-in-out infinite',
          padding: '0 20px'
        }}
      >
        Mulai instruksi.

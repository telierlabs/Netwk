...
export const ChatPage: React.FC<ChatPageProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden relative">
      ...
      {/* 🔥 TOMBOL PANAH KE BAWAH (Naikin ke bottom-44 biar ga nempel!) */}
      <div 
        className={`absolute bottom-44 right-5 md:right-8 z-[60] transition-all duration-300 ${showScrollButton ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-4 scale-90 pointer-events-none'}`}
      >
        <button 

...
// UPDATE LENGKAP: Komponen Animasi Premium DNA Helix Spin (Solid Black/White & Super Ringan)
const DnaHelixLoading = () => (
  <div className="flex items-center py-4 pl-2">
    <style>{`
      @keyframes helix-bounce-1 {
        0%, 100% { transform: translateY(-6px) scale(0.75); opacity: 0.4; }
        50% { transform: translateY(6px) scale(1.3); opacity: 1; }
      }
      @keyframes helix-bounce-2 {
        0%, 100% { transform: translateY(6px) scale(1.3); opacity: 1; }
        50% { transform: translateY(-6px) scale(0.75); opacity: 0.4; }
      }
    `}</style>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', height: '24px', position: 'relative', width: '70px', justifyContent: 'space-between' }}>
      {/* Node Pasang 1 */}
      <div style={{ position: 'relative', width: '10px', height: '100%' }}>
        <div style={{ position: 'absolute', top: '8px', width: '5px', height: '5px', borderRadius: '50%', background: 'var(--text)', animation: 'helix-bounce-1 1s ease-in-out infinite' }} />
        <div style={{ position: 'absolute', top: '8px', width: '5px', height: '5px', borderRadius: '50%', background: 'var(--text)', animation: 'helix-bounce-2 1s ease-in-out infinite' }} />
      </div>
      {/* Node Pasang 2 */}
      <div style={{ position: 'relative', width: '10px', height: '100%' }}>
        <div style={{ position: 'absolute', top: '8px', width: '5px', height: '5px', borderRadius: '50%', background: 'var(--text)', animation: 'helix-bounce-1 1s ease-in-out infinite', animationDelay: '-0.2s' }} />
        <div style={{ position: 'absolute', top: '8px', width: '5px', height: '5px', borderRadius: '50%', background: 'var(--text)', animation: 'helix-bounce-2 1s ease-in-out infinite', animationDelay: '-0.2s' }} />
      </div>
      {/* Node Pasang 3 */}
      <div style={{ position: 'relative', width: '10px', height: '100%' }}>
        <div style={{ position: 'absolute', top: '8px', width: '5px', height: '5px', borderRadius: '50%', background: 'var(--text)', animation: 'helix-bounce-1 1s ease-in-out infinite', animationDelay: '-0.4s' }} />
        <div style={{ position: 'absolute', top: '8px', width: '5px', height: '5px', borderRadius: '50%', background: 'var(--text)', animation: 'helix-bounce-2 1s ease-in-out infinite', animationDelay: '-0.4s' }} />
      </div>
      {/* Node Pasang 4 */}
      <div style={{ position: 'relative', width: '10px', height: '100%' }}>
        <div style={{ position: 'absolute', top: '8px', width: '5px', height: '5px', borderRadius: '50%', background: 'var(--text)', animation: 'helix-bounce-1 1s ease-in-out infinite', animationDelay: '-0.6s' }} />
        <div style={{ position: 'absolute', top: '8px', width: '5px', height: '5px', borderRadius: '50%', background: 'var(--text)', animation: 'helix-bounce-2 1s ease-in-out infinite', animationDelay: '-0.6s' }} />
      </div>
      {/* Node Pasang 5 */}
      <div style={{ position: 'relative', width: '10px', height: '100%' }}>
        <div style={{ position: 'absolute', top: '8px', width: '5px', height: '5px', borderRadius: '50%', background: 'var(--text)', animation: 'helix-bounce-1 1s ease-in-out infinite', animationDelay: '-0.8s' }} />
        <div style={{ position: 'absolute', top: '8px', width: '5px', height: '5px', borderRadius: '50%', background: 'var(--text)', animation: 'helix-bounce-2 1s ease-in-out infinite', animationDelay: '-0.8s' }} />
      </div>
    </div>
  </div>
);
            ...
            {messages.map((msg, i) => {
              ...
              return (
                <React.Fragment key={i}>
                  ...
                  {/* LOADING DENGAN ANIMASI DNA HELIX SPIN */}
                  {showLoadingHere && (

...
import { Pin, ChevronDown } from 'lucide-react'; // 🔥 Tambah icon ChevronDown
...
export const ChatPage: React.FC<ChatPageProps> = ({
  ...
  // 🔥 STATE BUAT NAMPILIN TOMBOL SCROLL
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden relative">
      ...
      {/* AREA CHAT (Ditambahin onScroll) */}
      <main 
        onScroll={handleScroll} // 🔥 EVENT LISTENER SCROLL DITAMBAH DI SINI
      ...
      {/* 🔥 TOMBOL SCROLL KE BAWAH (Muncul kalo showScrollButton = true) */}
      <div 
        className={`absolute bottom-24 right-6 md:right-10 z-40 transition-all duration-300 ${showScrollButton ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}
      >
        <button 
          onClick={scrollToBottom}
          className="w-10 h-10 flex items-center justify-center bg-[var(--text)] text-[var(--bg)] rounded-full shadow-[0_8px_30px_rgba(0,0,0,0.12)] hover:scale-110 active:scale-95 transition-transform"
        >

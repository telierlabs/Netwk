...
import { CylenCanvas } from '../components/canvas/CylenCanvas'; // 🔥 PASTIKAN IMPORT INI ADA
...
export const ChatPage: React.FC<ChatPageProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden relative">
      ...
      {/* 🔥 AREA CANVAS (MUNCUL DI ATAS KALO AKTIF) */}
      {isCanvasActive && (
        <div className="w-full h-[55vh] md:h-[65vh] flex-shrink-0 border-b border-[var(--bd)] relative z-0 transition-all duration-500 bg-[#050505]">
          <CylenCanvas />
        </div>
      )}

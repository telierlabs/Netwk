...
/* ── 1. Normal Chat Loading (Spinner Kepotong / Dual Ring) ── */
const NormalLoading = ({ text }: { text: string }) => (
  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 4 }}>
    ...
    `}</style>
    {/* Spinner 2 arah (kepotong transparan di kiri-kanan) */}
    <div style={{ 
      width: 16, height: 16, 
...
/* ── 2. Web Search Loading (TelierNews Node) ── */
const WebSearchLoading = ({ query }: { query: string }) => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14, width: '100%', marginTop: 4 }}>
      ...
      {/* Bagian Atas: Teks Mencari Biasa */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <div style={{ width: 14, height: 14, border: '2px solid var(--bd)', borderTopColor: 'var(--text)', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
        <span style={{ fontSize: 13, color: 'var(--mu)', fontWeight: 500 }}>
          Mencari informasi...
        </span>
      </div>

      {/* Bagian Bawah: Logo TelierNews & Query User */}
      <div style={{ 
        ...
        {/* Logo (Statis tapi ada efek napas / pulse) */}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <span style={{ 
              fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.05em', fontFamily: 'monospace',

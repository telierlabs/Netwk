...
export const ChatPage: React.FC<ChatPageProps> = ({
  ...
  // MODIFIKASI: showLoading HANYA untuk pencarian web atau nunggu AI mikir awal banget (sebelum animasi PDF mulai)
  const showLoading = isSending && activityStatus === 'idle' && (!lastAiMsgHasContent || isSearching);

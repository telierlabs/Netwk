...
export const ChatPage: React.FC<ChatPageProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden relative">
      ...
      {/* 🔥 AREA CANVAS: Latar ngikutin tema (bg-[var(--bg)]), border bawah buat misahin */}
      {isCanvasActive && (
        <div className="w-full h-[55vh] md:h-[65vh] flex-shrink-0 border-b border-[var(--bd)] relative z-0 transition-all duration-500 bg-[var(--bg)] shadow-[inset_0_-20px_20px_-20px_rgba(0,0,0,0.05)]">
          <CylenCanvas />
        </div>
      )}
      ...
      {/* AREA CHAT MENGISI SISA LAYAR */}
      <main className="flex-1 overflow-y-auto p-4 md:p-8 flex flex-col relative z-10 bg-[var(--bg)]">

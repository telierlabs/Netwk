...
// UPDATE: Perbaikan Posisi ke Kiri Total & Pembangkit Teks 1-3 Kata To-The-Point
const CylenDynamicLoading: React.FC<{ isSearching: boolean; userPrompt: string }> = ({ isSearching, userPrompt }) => {
  const getStatusText = () => {
    ...
    // Klasifikasi Ekstrem To-The-Point (1-3 Kata Maksimun)
  ...
  return (
    // justify-start & pl-1 menggeser seluruh bagian loading presisi ke sisi kiri linear

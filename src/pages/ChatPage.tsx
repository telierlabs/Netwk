...
export const ChatPage: React.FC<ChatPageProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden relative bg-[var(--bg)]">
            ...
            {messages.map((msg, i) => {
              ...
              return (
                <React.Fragment key={i}>
                  {/* ✅ FIX: Hapus contentVisibility:auto — ini bikin browser skip event handler
                      untuk elemen di luar viewport sehingga tap/click tidak terdeteksi */}
      ...
      {/* ✅ FIX: pointer-events-none di wrapper, pointer-events-auto hanya di ChatInput sendiri
          Ini mencegah wrapper absolute z-[100] ini mengintercept semua tap di area chat */}

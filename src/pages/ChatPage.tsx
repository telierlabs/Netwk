...
const WebSearchLoading = ({ query }: { query: string }) => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14, width: '100%', marginTop: 8 }}>
      ...
      {/* Bagian Atas: Loading Status (Clean, Tanpa Ikon Bot Bulan Sabit) */}
      ...
      {/* Bagian Bawah: Detail Query dengan Branding (Clean, Tanpa bubble/titik/teks 'MENCARI:') */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, paddingLeft: 30 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, minWidth: 0 }}>
          {/* Judul Branding Tetap Ada */}
          <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--text)', letterSpacing: '-0.02em', textTransform: 'uppercase' }}>
            TELIERNEWS NETWORK
          </span>
          {/* Hanya String Query User yang Menarik Data */}
          <span style={{

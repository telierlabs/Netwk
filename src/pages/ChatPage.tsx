...
// UPDATE: Garis bulat lingkaran samarnya dihapus murni, menyisakan partikel orbit adaptif
const EmptyState = () => (
  <div className="flex-1 flex flex-col items-center justify-center select-none pointer-events-none relative overflow-hidden" style={{ paddingBottom: '14vh' }}>
    ...
    <div className="relative w-[360px] h-[360px] flex items-center justify-center" style={{ animation: 'text-fade-in-premium 0.8s cubic-bezier(0.16, 1, 0.3, 1) both' }}>
      ...
      {/* RING 1: Partikel Luar (Searah jarum jam) */}
      <div style={{ position: 'absolute', width: '100%', height: '100%', animation: 'particle-orbit-clockwise 22s linear infinite' }}>
        <div style={{ position: 'absolute', top: '12%', left: '20%', width: 4.5, height: 4.5, borderRadius: '50%', background: 'var(--text)', opacity: 0.4 }} />
        <div style={{ position: 'absolute', bottom: '15%', right: '18%', width: 5, height: 5, borderRadius: '50%', background: 'var(--text)', opacity: 0.35 }} />
        <div style={{ position: 'absolute', top: '75%', left: '10%', width: 4, height: 4, borderRadius: '50%', background: 'var(--text)', opacity: 0.3 }} />
        <div style={{ position: 'absolute', top: '40%', right: '5%', width: 5.5, height: 5.5, borderRadius: '50%', background: 'var(--text)', opacity: 0.45 }} />
        <div style={{ position: 'absolute', bottom: '8%', left: '45%', width: 3.5, height: 3.5, borderRadius: '50%', background: 'var(--text)', opacity: 0.25 }} />
      </div>

      {/* RING 2: Partikel Tengah (Berlawanan arah jarum jam) */}
      <div style={{ position: 'absolute', width: '78%', height: '78%', animation: 'particle-orbit-counter 16s linear infinite' }}>
        <div style={{ position: 'absolute', top: '8%', right: '25%', width: 5, height: 5, borderRadius: '50%', background: 'var(--text)', opacity: 0.45 }} />
        <div style={{ position: 'absolute', bottom: '22%', left: '12%', width: 4.5, height: 4.5, borderRadius: '50%', background: 'var(--text)', opacity: 0.38 }} />
        <div style={{ position: 'absolute', top: '62%', right: '8%', width: 3.5, height: 3.5, borderRadius: '50%', background: 'var(--text)', opacity: 0.5 }} />
        <div style={{ position: 'absolute', top: '25%', left: '5%', width: 5.5, height: 5.5, borderRadius: '50%', background: 'var(--text)', opacity: 0.4 }} />
        <div style={{ position: 'absolute', bottom: '5%', right: '35%', width: 4, height: 4, borderRadius: '50%', background: 'var(--text)', opacity: 0.32 }} />
      </div>

      {/* RING 3: Partikel Dalam (Searah jarum jam) */}
      <div style={{ position: 'absolute', width: '56%', height: '56%', animation: 'particle-orbit-clockwise 11s linear infinite' }}>
        <div style={{ position: 'absolute', top: '2%', left: '48%', width: 4.5, height: 4.5, borderRadius: '50%', background: 'var(--text)', opacity: 0.5 }} />
        <div style={{ position: 'absolute', bottom: '10%', right: '25%', width: 5, height: 5, borderRadius: '50%', background: 'var(--text)', opacity: 0.42 }} />
        <div style={{ position: 'absolute', top: '45%', left: '0%', width: 4, height: 4, borderRadius: '50%', background: 'var(--text)', opacity: 0.48 }} />
        <div style={{ position: 'absolute', bottom: '30%', left: '85%', width: 3.5, height: 3.5, borderRadius: '50%', background: 'var(--text)', opacity: 0.35 }} />
      </div>

      {/* Konten Teks Tengah Utama - Hitam Pekat / Putih Bersih (100% Solid Opacity) */}
      <h1 
        style={{

...
// UPDATE: Ditambahkan teks "Mulai instruksi." tepat di tengah layar kosong
const EmptyState = () => (
  <div className="flex-1 flex items-center justify-center select-none pointer-events-none" style={{ paddingBottom: '10vh' }}>
    <span className="text-[17px] font-medium tracking-wide text-neutral-400 dark:text-neutral-500">
      Mulai instruksi.
    </span>
  </div>
);

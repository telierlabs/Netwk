...
export const ChatPage: React.FC<ChatPageProps> = ({
  ...
  // 🔥 EVENT LISTENER AUTO OPEN CANVAS JIKA ADA KARTU AI BARU
  useEffect(() => {
    const openCanvas = () => {
      if (!isCanvasActive && onOpenCanvas) onOpenCanvas();
    };
    window.addEventListener('cylen-canvas-update', openCanvas);
    return () => window.removeEventListener('cylen-canvas-update', openCanvas);
  }, [isCanvasActive, onOpenCanvas]);

...
export const ChatPage: React.FC<ChatPageProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden relative bg-[var(--bg)]">
      ...
      {/* ✅ LOADING INDICATOR — di LUAR scroll container, sticky di atas chat input */}
      {isSending && (
        <div
          className="absolute left-0 right-0 z-40 px-6 py-3 pointer-events-none"
          style={{
            bottom: 'calc(var(--chat-input-height, 120px))',
      ...
      >
        {isEmptyChat && !isSending ? <EmptyState /> : (
          <div className="max-w-3xl mx-auto flex flex-col gap-10 w-full pb-[160px]">
            ...
            {/* Spacer buat scroll — loading udah dipindah keluar */}
            {isSending && <div style={{ height: 60 }} />}

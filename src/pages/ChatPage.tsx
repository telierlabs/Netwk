...
/* ─── GHOST EMPTY STATE — gaya Grok Private Chat ─── */
  ...
  >
    ...
    <div style={{ animation: 'ghost-float 3.5s ease-in-out infinite, ghost-in 0.4s ease-out both' }}>
      <svg
        ...
        fill="none" stroke="var(--text)" strokeWidth="1.1"
    ...
    {/* Teks */}
    <div
      className="flex flex-col items-center gap-3 text-center mt-7"
      style={{ animation: 'ghost-in 0.4s 0.12s ease-out both', opacity: 0 }}
    >
      <span
        style={{ fontSize: 26, fontWeight: 700, color: 'var(--text)', opacity: 0.82, letterSpacing: '-0.01em' }}
      >
        Private Chat
      </span>
      <span
        style={{ fontSize: 15, color: 'var(--text)', opacity: 0.38, lineHeight: 1.55, maxWidth: 270 }}
      >
...
export const ChatPage: React.FC<ChatPageProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden relative bg-[var(--bg)]">
      ...
      >
        {isEmptyChat ? (
          /* Ghost empty state atau kosong biasa */

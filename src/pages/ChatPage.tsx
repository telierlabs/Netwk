...
interface ChatPageProps {
  ...
  isCanvasActive?: boolean; // 🔥 PROP DARI APP GLOBAL
  onOpenCanvas?: () => void; // 🔥 PROP DARI APP GLOBAL
}
    ...
    return (
      <div style={{ width: '100%' }}>
        <ChatInput 
          ...
          isCanvasActive={isCanvasActive} // 🔥 TERUSIN
          onOpenCanvas={onOpenCanvas}     // 🔥 TERUSIN
        />
      </div>
    );
  }

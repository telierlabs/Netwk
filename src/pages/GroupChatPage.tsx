...
// IMPORT SUDAH DIGANTI KE GROUP CHAT BUBBLE
          ...
          {activeGroup.messages.map((msg, i) => (
            <div key={i} className={cn("flex flex-col", msg.role === 'user' ? "items-end" : "items-start")}>
              {msg.role === 'system' ? (
                ...
                // KOMPONEN RENDER SUDAH DIGANTI KE GROUP CHAT BUBBLE
                <GroupChatBubble msg={msg} msgIndex={i} />
              )}
            </div>
          ))}
        ...
        {showFullAvatar && (
          ...
          >
            <div className="px-4 py-4 flex items-center justify-between bg-gradient-to-b from-black/60 to-transparent absolute top-0 w-full z-10">
              ...
              {/* Tombol Edit Langsung Loncat ke Halaman Profil */}

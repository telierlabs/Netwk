...
interface GroupChatPageProps {
  ...
  isSending: boolean;
  // UPDATE: Tambahkan images sebagai array string opsional
...
export const GroupChatPage: React.FC<GroupChatPageProps> = ({
  ...
  // UPDATE: Tangkap images dari komponen GroupChatInput dan lempar ke onSendMessage
  const handleSend = (images?: string[], pdfs?: { data: string; name: string }[]) => {
    // Validasi: Kalau teks kosong DAN gambar kosong, jangan kirim

...
import { GroupChatInput } from '../components/chat/GroupChatInput'; // <-- INI YANG BERUBAH
...
export const GroupChatPage: React.FC<GroupChatPageProps> = ({
  ...
  const handleSend = (images?: string[], pdfs?: { data: string; name: string }[]) => {
    // onSendMessage di group chat kita saat ini cuma terima 1 parameter (text)
    // kalau lu mau grup chat lu support gambar/pdf, lu harus update tipe fungsi onSendMessage lu.
    // Untuk saat ini kita kirim text aja.

...
export const GroupChatPage: React.FC<GroupChatPageProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-[var(--bg)] relative outline-none">
      ...
      {/* SUB-HEADER GLASSMORPHISM & WA PROFILE */}
      <div className="px-3 py-3 border-b border-[var(--bd)]/50 bg-[var(--bg)]/70 backdrop-blur-xl flex items-center justify-between sticky top-0 z-10 transform-gpu outline-none">
        <div className="flex items-center gap-3 outline-none">
          <div className="flex items-center gap-1 cursor-pointer hover:opacity-80 transition-opacity outline-none [-webkit-tap-highlight-color:transparent]" onClick={onNavigateProfile || onBack}>

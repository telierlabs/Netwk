...
export const ChatPage: React.FC<ChatPageProps> = ({
  ...
  // ✅ Cari index pesan user terakhir buat nempelin loading di bawahnya
      ...
      >
        {isEmptyChat && !isSending ? <EmptyState /> : (
          <div className="max-w-3xl mx-auto flex flex-col gap-10 w-full pb-[160px]">
            {messages.map((msg, i) => {
              ...
              return (
                <React.Fragment key={i}>
                  ...
                  {/* ✅ LOADING INDICATOR — Diselipkan tepat di bawah pesan user, jadi teks AI bakal muncul di bawahnya */}
                  {showLoadingHere && (
            ...
            {/* Buat jaga-jaga kalau isSending nyala tapi pesan user belum ke-push ke array */}

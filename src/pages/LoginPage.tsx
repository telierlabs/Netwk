...
export const LoginPage: React.FC<{ onLoginSuccess?: () => void }> = ({ onLoginSuccess }) => {
  ...
  // 👇 State ditambahin 'news-detail' dan 'contact'
  ...
  // 👇 Routing buat halaman Legal, News & Contact
  ...
  if (activePage === 'contact') return <LegalDetail type="contact" onBack={() => setActivePage('home')} onNavigate={(p) => setActivePage(p as any)} />; // <-- Routing halaman contact

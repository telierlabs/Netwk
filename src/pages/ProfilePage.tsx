...
import { 
  ...
  Camera, Trash2, Image as ImageIcon, X, Check, Edit2 
} from 'lucide-react';
    ...
    <main className="flex-1 overflow-y-auto bg-[var(--bg)] relative z-50" style={{ minHeight: 0 }}>
      ...
      <div className="max-w-2xl mx-auto pb-10">
        ...
        <div className="bg-[var(--sf)] rounded-[24px] p-4 flex items-center gap-4 mx-4 mt-2 border border-[var(--bd)]/50">
          ...
          {/* Avatar Area */}
          <div className="relative cursor-pointer group shrink-0" onClick={() => setShowAvatarMenu(true)}>
            {displayAvatar ? (
              <img src={displayAvatar} alt="Profile" className="w-[60px] h-[60px] rounded-full object-cover bg-[var(--bd)]" />
            ) : (
            ...
            <div className="absolute -bottom-1 -right-1 w-7 h-7 bg-[var(--text)] text-[var(--bg)] rounded-full flex items-center justify-center shadow-md border-[2.5px] border-[var(--sf)] transition-transform group-hover:scale-110">

...
import { Palette, ChevronRight, Check, Shield, Zap, Download, FileText, LogOut, Smartphone, Wand2, Network, BarChart3 } from 'lucide-react';
...
export const ProfilePage: React.FC<ProfilePageProps> = ({
  showToast, onViewAppearance, onViewAiSettings, onViewUsage, onViewIntegrations, onViewSecurity, onViewExport, onUpgradeClick
}) => {

...
export const GroupListPage: React.FC<GroupListPageProps> = ({
  ...
  return (
    <main className="flex-1 flex flex-col bg-[var(--bg)] overflow-hidden outline-none">
      ...
      <div className="px-4 py-3 border-b border-[var(--bd)]/50 bg-[var(--bg)]/80 backdrop-blur-md flex items-center gap-3 sticky top-0 z-20 outline-none">
        ...
        <div className="relative flex-1 outline-none">
          ...
          <input 
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-[var(--sf)] border border-[var(--bd)] rounded-[16px] text-[14px] font-medium outline-none focus:ring-1 focus:ring-[var(--text)]/20 transition-all placeholder:text-[var(--mu)] [-webkit-tap-highlight-color:transparent]"
          />
        </div>
      </div>

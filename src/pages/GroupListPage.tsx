    ...
    <main className="flex-1 flex flex-col bg-[var(--bg)] overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto">
        {isCreating ? (
          ...
          >
            <div className="w-12 h-12 bg-indigo-500 text-white rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
              <Plus size={24} />
            </div>
        ...
        {filteredGroups.length === 0 ? (
          ...
          filteredGroups.map((group) => {
            ...
            return (
              ...
              >
                <div className="relative">
                  <div className="w-14 h-14 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white text-xl font-bold shadow-md group-hover:scale-105 transition-transform">
                    {group.title[0]}
                  </div>
      ...
      {/* Bottom Floating Action Button (Mobile style) */}

...
export const GroupListPage: React.FC<GroupListPageProps> = ({
  ...
  return (
    <main className="flex-1 flex flex-col bg-[var(--bg)] overflow-hidden">
      ...
      {/* ─── HEADER: panah kembali + "Grup AI" + search ─── */}
      <div className="px-4 py-3 border-b border-[var(--bd)]/15 bg-[var(--bg)] sticky top-0 z-20">
        {/* Top row: back + title */}
        <div className="flex items-center gap-2 mb-3">
          <button
            onClick={onBack}
            className="w-9 h-9 flex items-center justify-center rounded-full hover:bg-[var(--sf)] text-[var(--text)] transition-colors active:scale-95 shrink-0"
          >

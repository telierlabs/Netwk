  ...
  return (
    ...
    >
      ...
      <div className={cn('flex items-center py-4 px-2', collapsed ? 'flex-col gap-3' : 'px-3 gap-2 justify-between')}>
        {/* Logo PNG — klik = new chat */}
        <button
          onClick={onNewChat}
          title="Cylen AI"
          className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 hover:opacity-70 transition-opacity"
        >
          <img
  ...
  if (isEmpty) {
    return (
      ...
      >
        ...
        {/* Logo + nama — STATIC, tidak ada animasi */}
        <div className="flex items-center gap-3 mb-8">
          ...
          <span
            ...
            style={{ fontSize: '2.7rem', letterSpacing: '-0.02em', lineHeight: 1 }}
          >
            Cylen
          </span>
        </div>

...
export default function AppDesktop() {
  ...
  // MENGOPER ACTIVITY STATUS KE CHATPAGE
  const chatProps = {
    messages, isSending, isSearching, activityStatus, // <-- TAMBAHAN BARU

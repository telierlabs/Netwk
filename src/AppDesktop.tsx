...
export default function AppDesktop() {
  ...
  // ── FIX: TANGKAP leaveGroup ──
  const { activeGroup, groupSessions, setActiveGroupId, isSending: isGroupSending, thinkingAI, createGroup, addParticipant, sendGroupMessage, joinGroup, leaveGroup } = useGroupChat();
  ...
  if (isAuthLoading) return <div style={{ height: '100dvh', width: '100vw', backgroundColor: '#ffffff' }} />;
    ...
    <div className={cn('app transition-colors duration-350', theme)} style={{ fontFamily: currentFontFamily, height: '100dvh', display: 'flex', overflow: 'clip' }}>
      ...
      <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden', position: 'relative' }}>
        ...
        <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          {/* ── FIX: OPER leaveGroup & setView KE GroupProfilePage ── */}

...
import { chatWithGeminiStream, generateImageWithGemini, editImageWithGemini } from '../services/geminiService';
...
// Cek apakah AI ingin generate atau edit gambar
...
export function useChat() {
  ...
  const sendMessage = async (
    ...
    try {
      ...
      // Setelah stream selesai — cek apakah AI minta generate/edit gambar

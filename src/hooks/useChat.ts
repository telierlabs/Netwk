...
// 🔥 FUNGSI SUPER SENSOR: Membunuh teks JSON sebelum bocor ke layar
function hideJsonCanvasWhileStreaming(text: string): string {
  ...
  // Cegah kebocoran saat AI baru ngetik sebagian dari "```json-canvas"

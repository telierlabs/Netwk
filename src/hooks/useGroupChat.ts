...
3. DILARANG KERAS memulai jawabanmu dengan namamu sendiri seperti "[${ai.name}]: ". Langsung tulis saja isi jawabanmu.`;
        ...
        let fullText = "";
        let displayedText = ""; // ── FIX: Menyimpan teks yang udah "halus" buat ditampilin di UI ──
        ...
        for await (const chunk of stream) {
          ...
          // ── FIX: ALGORITMA EFEK NGETIK HALUS (SMOOTH TYPING) ──
          // Kita pecah teks yang baru dateng jadi kumpulan kata/karakter, terus kita loop pake timeout
          ...
          for (let i = 0; i < chars.length; i++) {
            ...
            // Render UI per beberapa karakter biar nggak terlalu memberatkan browser
            ...
            // Jeda milidetik (makin kecil makin cepet, 10ms = pas)

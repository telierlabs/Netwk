        ...
        <>
          ...
          <div className="fixed inset-0 z-[201] flex items-center justify-center pointer-events-none px-4">
            ...
            <motion.div
              ...
              style={{
                width: '100%',
                maxWidth: '380px', // Sedikit lebih lebar untuk ruang bernapas
                maxHeight: '440px', // Memuat ~4 AI sebelum di-scroll
                borderRadius: '24px', // Radius lebih besar (seperti Apple/iOS)
                backgroundColor: '#ffffff',
                display: 'flex',
                flexDirection: 'column',
                overflow: 'hidden',
                // Shadow premium: lembut dan menyebar
            ...
            >
              ...
              >
                <div>
                  <div style={{ fontSize: 18, fontWeight: 700, color: '#111827', letterSpacing: '-0.4px' }}>
                    Kelola AI
                  </div>
                ...
                <button
                  ...
                  style={{
                    width: 32,
                    height: 32,
                    borderRadius: '50%', // Tombol close bulat penuh
                    background: '#F3F4F6',
                    border: 'none',
                    display: 'flex',
                    alignItems: 'center',
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        gap: 14,
                        padding: '12px',
                        borderRadius: '16px', // Radius dalam mengikuti radius luar
                        background: isAdded ? '#FAFAFA' : '#FFFFFF',
                        border: isAdded ? '1px solid rgba(0,0,0,0.03)' : '1px solid transparent',
                        transition: 'all 0.2s ease',
                      }}
                      onMouseEnter={e => {
                        if(!isAdded) e.currentTarget.style.background = '#F9FAFB';
                      }}
                      onMouseLeave={e => {
                        if(!isAdded) e.currentTarget.style.background = '#FFFFFF';
                      }}
                    >
                      {/* Icon AI dengan soft background */}
                      <div
                        style={{
                          width: 44,
                          height: 44,
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                          ...
                          {isAdded && (
                            <span style={{
                              ...
                              <span style={{ fontSize: 11, fontWeight: 500, color: '#4B5563' }}>Aktif</span>
                            </span>
                          )}
                        </div>
                      ...
                      {/* Tombol Aksi Mewah (Pill / Circular) */}
                      {isAdded ? (
                        <button
                          ...
                          style={{
                            ...
                            height: 36,
                            borderRadius: '50%',
                            background: '#FFF1F2', // Soft Red/Rose background

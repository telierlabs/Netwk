          ...
          <div className="fixed inset-0 z-[201] flex items-center justify-center pointer-events-none px-4">
            ...
            <motion.div
              ...
              style={{
                width: '100%',
                maxWidth: '350px',
                // Dibatasi sekitar 340px agar hanya menampilkan ~4 AI
                maxHeight: '340px',
                borderRadius: '12px', // Lebih "kotak" dibanding sebelumnya
                display: 'flex',
                flexDirection: 'column',
                overflow: 'hidden',
                boxShadow: '0 12px 40px rgba(0,0,0,0.2)',
                border: '2px solid #000', // Border tegas hitam
              }}
            >
              {/* Header */}
              <div
                style={{
                  ...
                  flexShrink: 0,
                  borderBottom: '2px solid #000', // Border garis hitam tegas
                }}
              >
                <div>
                  <div style={{ fontSize: 16, fontWeight: 800, color: '#000', letterSpacing: '-0.3px' }}>
                    Kelola AI
                  </div>
                  <div style={{ fontSize: 13, color: '#444', marginTop: 2, fontWeight: 500 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    height: 32,
                    borderRadius: 8,
                    border: '2px solid #000', // Tombol close hitam putih
                    background: '#fff',
                    display: 'flex',
                    alignItems: 'center',
                  ...
                  return (
                    <div
                      ...
                      style={{
                        display: 'flex',
                        alignItems: 'center',
                        gap: 12, // Gap lebih besar
                        padding: '8px',
                        borderRadius: 8,
                        background: isAdded ? '#f9f9f9' : 'transparent',
                        border: isAdded ? '1px solid #ddd' : '1px solid transparent',
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          justifyContent: 'center',
                          flexShrink: 0,
                          border: `1.5px solid ${ai.iconColor}33`,
                        }}
                      >
                        <ai.Logo size={24} />
                      </div>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: 15, fontWeight: 700, color: '#000', lineHeight: 1.3 }}>
                          {ai.name}
                          {isAdded && (
                            <span style={{
                              marginLeft: 8,
                              ...
                              fontWeight: 800,
                              color: '#fff',
                              background: '#000', // Badge aktif hitam putih
                              borderRadius: 4,
                              padding: '2px 6px',
                              letterSpacing: 0.5,
                            }}>
                        ...
                        <div style={{ fontSize: 13, color: '#555', marginTop: 2, fontWeight: 500 }}>
                          {ai.model}
                        </div>
                      </div>

                      {/* Tombol Aksi Hitam/Putih */}
                      {isAdded ? (
                        <button
                          onClick={() => handleRemove(ai)}
                          title="Keluarkan dari grup"
                          style={{
                            width: 36, // Tombol lebih besar
                            height: 36,
                            borderRadius: 8,

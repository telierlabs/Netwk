...
import { ChevronRight, Search, User, Settings, Bookmark, Layout, Users, ChevronsRight } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({
  isOpen, onClose, chatSessions, activeChatId, onSelectChat, onViewProfile, onViewGroup, onViewSaved
}) => {

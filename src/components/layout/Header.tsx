...
interface HeaderProps {
  ...
  isEmptyChat?: boolean; // 🔥 TAMBAHAN PROP DETEKSI CHAT KOSONG
}
  ...
  return (
    <header className={cn(
      ...
      <div className="flex items-center gap-3">
        ...
        >
          {isEmptyChat ? (
            // 🔥 ICON HANTU (GHOST) KALO GADA CHAT (KAYA GROK TEMPORARY CHAT)
            ...
            // 🔥 ICON PENSIL (SQUARE PEN) KALO ADA CHAT KEKIRIM
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--text)" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">

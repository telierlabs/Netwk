...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className={cn(
      "flex-shrink-0 grid grid-cols-[auto_1fr_auto] items-center px-4 z-20 transition-all duration-300 ease-out outline-none [-webkit-tap-highlight-color:transparent]", 
      ...
      <div className="flex items-center gap-2 outline-none">
        {/* Ikon Kamera dicabut dari sini pindah ke GroupChatPage biar gak numpuk di header utama */}
        <button 

...
import { ArrowLeft, SquarePen } from 'lucide-react'; // 🔥 Menu udah dicabut, kita pake SVG kustom
...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className={cn(
      ...
      // 🔥 FIX KACA BLUR & BORDER TIPIS: Blur maksimal, border super samar (opacity 0.03)
      "bg-[var(--bg)]/50 backdrop-blur-3xl backdrop-saturate-150 border-b border-[var(--text)]/[0.03] shadow-[0_4px_16px_rgba(0,0,0,0.02)] supports-[backdrop-filter]:bg-[var(--bg)]/40", 
      ...
      >
        {view === 'chat' ? (
          // 🔥 FIX IKON GARIS 2: Elegan, tebel pas, proporsional

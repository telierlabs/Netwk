...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className={cn(
      ...
      // 🔥 FIX HEADER KACA ABU: Disamain PERSIS kayak ChatInput. Warnanya dikunci, gak dibikin transparan total lagi!
      "bg-[var(--text)]/[0.04] backdrop-blur-md border-b-[1px] border-solid border-gray-500/20 shadow-[0_4px_24px_rgba(0,0,0,0.04)]", 

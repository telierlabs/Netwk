...
export const Header: React.FC<HeaderProps> = ({
  ...
  // 👇 GUA TAMBAHIN 'saved' dan 'group-profile' DI SINI BIAR HEADERNYA HILANG
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 outline-none">
        {view === 'chat' && (
          isEmptyChat ? (
            /* Tombol ghost — CUMA ICON YANG BERUBAH ITEM/NORMAL */
            <button
            ...
            >
              {isTemporary ? (
                // ICON HANTU ITEM (FILLED) SAAT AKTIF
                ...
                // ICON HANTU NORMAL (OUTLINE) SAAT MATI

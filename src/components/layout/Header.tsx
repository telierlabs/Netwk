...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    // 🔥 TAMBAH flex-shrink-0 DI SINI
    <header className={cn(
      "flex-shrink-0 grid grid-cols-[auto_1fr_auto] items-center px-4 bg-[var(--bg)]/80 backdrop-blur-md sticky top-0 z-10 transition-all duration-500 ease-in-out border-b border-transparent",

...
import { ArrowLeft, SquarePen, Menu } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className={cn(
      "flex-shrink-0 grid grid-cols-[auto_1fr_auto] items-center px-4 z-20 transition-[height,background-color,opacity,transform] duration-300 ease-out outline-none [-webkit-tap-highlight-color:transparent]", 
      // 🔥 FIX HEADER KACA ABU: Rumus disamain persis kayak ChatInput! bg-[var(--text)]/[0.04] + border-gray-500/20
      "bg-[var(--text)]/[0.04] backdrop-blur-3xl border-b-[1px] border-solid border-gray-500/20 supports-[backdrop-filter]:bg-transparent shadow-[0_4px_24px_rgba(0,0,0,0.02)]", 

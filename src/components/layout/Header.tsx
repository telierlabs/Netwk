...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className={cn(
      "flex-shrink-0 grid grid-cols-[auto_1fr_auto] items-center px-4 z-10 transition-all duration-300 ease-out",
      "bg-[var(--bg)]/40 backdrop-blur-2xl border-b border-[var(--text)]/5 shadow-[0_4px_30px_rgba(0,0,0,0.02)]", // 🔥 RACIKAN KACA GROK/VISION OS

...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className={cn(
      ...
      // 🔥 EFEK KACA MELELEH: Transparan + Blur Ekstrem
      "bg-gradient-to-b from-[var(--bg)]/80 to-[var(--bg)]/40 backdrop-blur-3xl supports-[backdrop-filter]:bg-transparent", 
      isCanvasActive ? "h-10 py-1" : "py-4"
    )}>
      <button 

  ...
  return (
    <header
      style={{
        ...
        borderBottom: '1px solid rgba(var(--text-rgb, 128,128,128), 0.1)',
        boxShadow: '0 1px 0 rgba(var(--text-rgb, 128,128,128), 0.06)',

        outline: 'none',
        WebkitTapHighlightColor: 'transparent',
        opacity: isCanvasActive ? 0.75 : 1,
        transition: 'opacity 0.3s ease, padding 0.3s ease',

        /* Sticky so it floats above scrolling content */
        position: 'sticky',
        top: 0,
      }}
    >

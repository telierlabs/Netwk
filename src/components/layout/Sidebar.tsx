  ...
  return (
    <div className="flex flex-col h-full bg-transparent" onClick={() => setOpenMenuId(null)}>
      ...
      <div className="px-6 pt-10 pb-6 flex items-center justify-between border-b border-[var(--text)]/5">
        ...
        {/* FIX: Tanda X diganti jadi >> (ChevronsRight) ukuran GEDE */}
      ...
      <div className="px-5 mb-5 mt-4">
        {/* FIX: Tasks aja, gausah pake Manager */}
      ...
      <div className="px-3 mb-3 flex flex-col gap-1">
        ...
        {/* FIX: Hapus class flex-1 yang bikin 'Disimpan' nabrak/turun, ganti jadi flex biasa biar sejajar */}
      ...
      {/* FIX: Container bawah ini bener-bener NO BACKGROUND. Isinya murni tombol-tombol melayang */}
      <div className="px-5 pb-8 pt-4 flex items-center gap-3 flex-shrink-0 relative z-20 bg-transparent"> 
        ...
        {/* Icon Settings & Plus Melayang Tanpa Kotak Pembungkus */}

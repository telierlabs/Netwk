...
const SidebarContent: React.FC<{
  ...
  customName: string; // <-- NAMBAH PROPS INI
  onSelectChat: (id: string) => void;
  onViewProfile: () => void;
  onViewGroup: () => void;
  onViewSaved: () => void;
  ...
  return (
    <div className="flex flex-col h-full relative bg-transparent">
      ...
      {/* --- FOOTER DESKTOP PROFIL & PENGATURAN --- */}
...
const MobileSidebarContent: React.FC<{
  ...
  return (
    <div className="flex flex-col h-full bg-transparent" onClick={() => setOpenMenuId(null)}>
      ...
      {/* --- HEADER MOBILE NAMPILIN NAMA BARU --- */}
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  // STATE SYNC BUAT NAMA & AVATAR USER
  ...
  useEffect(() => {
    const handleAvatarChange = () => {
      setCustomAvatar(localStorage.getItem('cylen_avatar'));
    };
    const handleNameChange = () => {
      setCustomName(localStorage.getItem('cylen_user_name') || 'User Premium');
    };
  ...
  const sharedProps = { 
    ...
    customAvatar, customName, // DIPASS KE DALAM

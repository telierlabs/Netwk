...
// ── MOBILE SIDEBAR CONTENT (layout khusus HP, mirip gambar 1) ──
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 pt-5 pb-3">
        <button
          ...
          className="w-full flex items-center gap-2 bg-[var(--sf)] rounded-xl px-3 py-2.5"
        >
          <Search size={14} className="text-[var(--mu)] flex-shrink-0"/>
          <span className="flex-1 text-left text-[13px] text-[var(--mu)]">Cari percakapan...</span>
          <ChevronsRight size={16} className="text-[var(--mu)]"/>
        </button>
      </div>
      ...
      <div className="px-4 mb-4">
        ...
        <div className="bg-[var(--sf)] rounded-2xl overflow-hidden">
          {[
            { icon: <Search size={16}/>, label: 'Cari Percakapan', onClick: () => { onViewSearch(); onClose(); } },
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 left-0 w-full bg-[var(--bg)] z-50 flex flex-col shadow-2xl md:hidden"
            >

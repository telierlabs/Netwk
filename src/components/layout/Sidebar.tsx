...
const SidebarContent: React.FC<{
  ...
  collapsed, chatSessions, activeChatId, customAvatar,
...
const MobileSidebarContent: React.FC<{
  ...
  chatSessions, activeChatId, customAvatar, onSelectChat, onViewProfile, onViewGroup, onViewSaved, 
      ...
      <div className="px-6 pt-6 pb-2 flex items-center justify-between border-none">
        <button onClick={() => { onViewProfile(); onClose(); }} className="flex items-center gap-3 active:scale-95 transition-all text-left">
          ...
          <div className="flex flex-col">
            <span className="text-[18px] font-bold text-[var(--text)] tracking-tight leading-tight">User Premium</span>
          </div>
        </button>
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  // TAMBAHAN: Listener Avatar untuk sinkronisasi otomatis
  ...
  const sharedProps = { 
    ...
    onViewSaved, onViewSearch, onNewChat, onPinChat, onClearAllChats, customAvatar,

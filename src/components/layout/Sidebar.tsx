...
// ── PERBAIKAN FINAL: Langsung Tembak String dari utils.ts ──
const formatSessionDate = (dateString?: string | Date | number) => {
  if (!dateString) return "BARU SAJA";

  // Karena format dari database (via utils.ts) SUDAH BENAR 
  // (cth: "MINGGU, 24 MEI 2026 12:51"), kita langsung kembalikan saja stringnya!
  if (typeof dateString === 'string') {
    return dateString; 
  }

  // Fallback cadangan kalau sewaktu-waktu data yang masuk bentuknya angka timestamp

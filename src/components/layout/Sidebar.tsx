...
const MobileSidebarContent: React.FC<{
  ...
  return (
    <div className="flex flex-col h-full bg-transparent" onClick={() => setOpenMenuId(null)}>
      ...
      {/* FIX POINT 4: Border dipastiin kelihatan jelas (border-[var(--text)]/15) dan pb dikurangin */}
      <div className="px-6 pt-10 pb-5 flex items-center justify-between border-b border-[var(--text)]/15">
        ...
        {/* FIX POINT 1: Size jadi 40, p-2 -mr-3 biar hitbox gede gampang diklik tapi posisi tetep pas */}
        <button onClick={onClose} className="p-2 -mr-3 rounded-2xl bg-transparent flex items-center justify-center text-[var(--text)] hover:bg-[var(--text)]/10 active:scale-90 transition-all">
          <ChevronsRight size={40} strokeWidth={2.5} />
        </button>
      </div>

      {/* FIX POINT 3: Margin mb-5 mt-4 dipotong jadi mb-3 mt-3, biar history nggak kesempitan bawahnya */}
      ...
      {/* FIX POINT 3: mb-3 dipotong jadi mb-2 */}
      ...
      <div className="px-3 flex-1 overflow-y-auto min-h-0 pb-4" style={{scrollbarWidth:'none'}}>
        ...
        {/* FIX POINT 3: mb-3 mt-4 dipotong jadi mb-2 mt-2 biar ruang list chat lebih dominan */}
      ...
      {/* FIX POINT 2: Ini wrapper murni z-20 tanpa border-t tanpa background. Nggak ada sisa background aneh-aneh. */}

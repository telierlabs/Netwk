...
export const GroupChatInput: React.FC<GroupChatInputProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    const newHeight = Math.min(el.scrollHeight, 120); // Dibuat lebih pendek max-height-nya buat gaya pill
  ...
  return (
    <>
      ...
      <footer className="px-3 pt-2 pb-6 relative z-50 w-full pointer-events-auto">
        ...
        {/* ─── KOTAK REPLY YG MUNCUL DI ATAS INPUT (Terpisah dari Input Box Utama) ─── */}
        <AnimatePresence>
          {replyingTo && (
        ...
        {/* ─── PREVIEW FILE ATTACHMENT (Terpisah dari Input Box Utama) ─── */}
        ...
        <div className="max-w-4xl mx-auto w-full">
          {isListening ? (
            ...
            <div className="flex items-end gap-2 w-full">
              ...
              {/* Tombol Send / Mic Terpisah di Kanan */}

...
import {
  ...
  X, Pin, PinOff, MoreVertical, Code, ChevronDown, ChevronUp,
  Edit2, Clock
} from 'lucide-react';
...
const GroupChatBubbleComponent: React.FC<GroupChatBubbleProps> = ({
  ...
  return (
    <div id={`message-${msgIndex}`} className={cn("flex flex-col group w-full relative transform-gpu", isUser ? "items-end" : "items-start", showUserMenu ? "z-[100]" : "z-10")}>
      ...
      {/* HEADER NAMA PENGIRIM UNTUK GRUP */}
      <div className="flex items-center gap-2.5 mb-2">
        <div className={cn("flex flex-col", isUser ? "items-end" : "items-start")}>
          <span className="text-[10px] font-bold text-[var(--text)] uppercase tracking-widest leading-none mb-1">{senderDisplayName}</span>
      ...
      {/* ── TOOLBAR BAWAH AI (Kecil & Minimalis) ── */}
      {!isUser && (
        <div className="flex items-center gap-[28px] mt-1 relative">
          ...
          {/* ICON SHARE DIHAPUS, SISANYA TINGGAL 4 ICON BAWAH */}

...
const ChatBubbleComponent: React.FC<ChatBubbleProps> = ({
  ...
  if (!isUser && isLast && activityStatus !== 'idle') {
    const statusMap = {
      ...
      ebook: { icon: <Bookmark size={22} />, text: 'Sedang merancang Visual Ebook...' }, // <-- EBOOK DITAMBAH DI SINI
    };
  ...
  if (fileMatch) {
    ...
    const icons: any = { 
        ...
        EBOOK: <Bookmark className="text-purple-500" /> // <-- ICON UNTUK LINK EBOOK
    };

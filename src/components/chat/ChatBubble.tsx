      ...
      {!isUser && (
        <div className="flex items-center gap-0.5 mt-2.5">
          ...
          <button onClick={handleCopy} title="Salin"
            className={cn(
              "flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-[12px] font-medium transition-all border border-transparent",
              copied
          ...
          <button onClick={() => setLiked(l => l === 'up' ? null : 'up')} title="Suka"
            className={cn(
              "p-2 rounded-xl transition-all border border-transparent text-[12px]",
              liked === 'up'
          ...
          <button title="Ulangi respons"
            className="p-2 rounded-xl transition-all border border-transparent text-[var(--mu)] hover:text-[var(--text)] hover:bg-[var(--sf)] hover:border-[var(--bd)]">
            <RotateCcw size={13} />
          </button>
          ...
          {suggestions.map((s, i) => (
            ...
            >
              ...
              <svg
                ...
                className="flex-shrink-0 text-[var(--ac)] opacity-70 group-hover/sug:opacity-100 transition-opacity"
                stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
              >
                <path d="M3 8h10M9 4l4 4-4 4" />
              </svg>
              <span className="text-[13px] text-[var(--ac)] font-medium underline underline-offset-2 decoration-[var(--ac)]/30 hover:decoration-[var(--ac)] transition-all leading-snug">
                {s}
              </span>
            </button>
          ))}

...
// ─── HELPER: Preprocess konten Gemini sebelum dirender ───
// Mengubah format ➤ **rumus** jadi $rumus$ agar KaTeX bisa render
function preprocessMathContent(content: string): string {
  // Ubah format ➤ **L = π × r²** → $$L = \pi \times r^2$$
  // Tapi karena Gemini pakai Unicode (bukan LaTeX), kita tetap tampilkan
  // sebagai styled block — bukan convert ke LaTeX
  // Yang kita handle: kalau ada $...$ atau $$...$$ dari Gemini, render via KaTeX
  return content;
}
            ...
            <motion.div drag="x" dragConstraints={{ left: 0, right: 0 }} dragElastic={0.1} onDragEnd={(_e, info) => { if (info.offset.x > 55) onSwipeToReply?.(msg); }} className="w-full">
              <div className="cylen-md w-full" style={{ userSelect: "text", WebkitUserSelect: "text" }}>
                <style>{`
                  ...
                  .cylen-md ul { list-style: disc; padding-left: 1.4rem; margin-bottom: 0.85rem; }
                  .cylen-md ol { list-style: decimal; padding-left: 1.4rem; margin-bottom: 0.85rem; }
                  ...
                  /* ── HR ── */
                  .cylen-md hr { border: none; border-top: 1px solid var(--bd); margin: 1.6rem 0; }
                  ...
                  /* ── KATEX MATH STYLING ── */
                  /* Inline math — ukuran sama dengan teks sekitarnya */
                  .cylen-md .katex { font-size: 1em; }

                  /* Block math ($$...$$) — tampil menonjol, centered, ukuran lebih besar */
                  ...
                  /* Warna simbol math mengikuti tema */
                  .cylen-md .katex .mord,
                  .cylen-md .katex .mbin,
                  .cylen-md .katex .mrel,

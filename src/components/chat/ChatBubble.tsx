    ...
    <div className={cn("flex flex-col group w-full", isUser ? "items-end" : "items-start")}>
      ...
      {msg.content && (
        <div className={cn(
          ...
          isUser
            ? "bg-[var(--ac)] text-[var(--at)] rounded-tr-none max-w-[78%] px-4 py-3 text-[15px] leading-relaxed"
      ...
      <div className={cn(
        ...
        {[
          { icon: copied ? <Check size={14} className="text-green-500" /> : <Copy size={14} />, action: handleCopy, title: 'Salin' },
          { icon: <ThumbsUp size={14} />, action: () => {}, title: 'Suka' },
          { icon: <ThumbsDown size={14} />, action: () => {}, title: 'Tidak Suka' },
          { icon: <Share2 size={14} />, action: () => {}, title: 'Bagikan' },
          { icon: <RotateCcw size={14} />, action: () => {}, title: 'Ulangi' },
          { icon: <ArrowLeftRight size={14} />, action: () => {}, title: 'Bandingkan' },
        ].map((btn, i) => (

  ...
  return (
    <div className={cn("flex flex-col group w-full", msg.role === 'user' ? "items-end" : "items-start")}>
      <div className="flex items-center gap-2.5 mb-2">
        {msg.role === 'assistant' && (
          <div className="w-7 h-7 flex items-center justify-center">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--mu)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      ...
      {((msg.images && msg.images.length > 0) || msg.image) && (() => {
        ...
        return (
          <div className={cn("mb-2", msg.role === 'user' ? "flex justify-end" : "")}>
            {count === 1 ? (

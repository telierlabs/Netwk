...
// ✅ RAHASIA 1: Memoize komponen berat seperti SyntaxHighlighter biar gak lag pas AI ngetik
...
// ✅ RAHASIA UTAMA: React.memo() memastikan pesan lama gak di-render ulang
...
// Ekspor komponen pake memo biar gila performanya pas di scroll atau ngetik
export const ChatBubble = memo(ChatBubbleComponent, (prev, next) => {
  // Hanya re-render jika isi konten atau status pin berubah

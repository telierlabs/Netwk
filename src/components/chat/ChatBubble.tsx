...
import {
  ...
  X, Pin, PinOff, Bookmark, MoreVertical, Code
} from 'lucide-react';
      ...
      {msg.content && (
        <div onClick={() => isUser && setShowUserSheet(true)}
          className={cn(
            ...
            isUser
              /* FIX 2 & 3: hitam, teks putih, lebar menyesuaikan konten */
          ...
          {isUser ? (
            ...
            <div className="cylen-md w-full">
              ...
              <Markdown remarkPlugins={[remarkGfm]} components={{
                ...
                /* FIX 1: tabel hanya render sebagai tabel, sisanya pakai list/paragraf via AI */

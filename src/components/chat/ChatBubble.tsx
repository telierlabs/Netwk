...
const ChatBubbleComponent: React.FC<ChatBubbleProps> = ({
  ...
  // ── JURUS JITU: POTONG KOMPAS JIKA LAGI LOADING PDF/GAMBAR ──
  // Langsung return animasi telanjang, JANGAN render bubble kotak, waktu, atau apapun!

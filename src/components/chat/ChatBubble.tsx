...
const ImageGallery = ({ src }: { src: string }) => {
  ...
  return (
    <>
      <div className="my-2 relative group inline-block rounded-xl overflow-hidden border border-[var(--bd)]">
        <img src={src} alt="Generated" className="object-cover cursor-pointer rounded-xl" style={{ width: 140, height: 140 }} onClick={() => setIsFullscreen(true)} />

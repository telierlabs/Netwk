...
const ImageGallery = ({ src }: { src: string }) => {
  ...
  return (
    <>
      <div className="mb-2 relative rounded-2xl overflow-hidden cursor-pointer" style={{ maxWidth: 280 }} onClick={() => setIsFullscreen(true)}>
        <img src={src} alt="" className="w-full h-auto block" style={{ maxHeight: 320, objectFit: 'cover' }} />
  ...
  return (
    <div className={cn("flex flex-col group w-full", msg.role === 'user' ? "items-end" : "items-start")}>
      ...
      <div className={cn(
        ...
        msg.role === 'user' 
          ? "bg-[var(--ac)] text-[var(--at)] rounded-tr-none max-w-[65%] inline-block" 

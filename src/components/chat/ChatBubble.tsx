...
interface ChatBubbleProps {
  msg: Message;
  msgIndex: number;
  isLast?: boolean; // ✅ Tambahan isLast
  ...
  return (
    <div className="w-full">
      ...
      <button
        ...
        style={{ color: 'var(--text)' }} // Changed from var(--at) so it's visible on var(--sf) background
      >
        {expanded ? (
...
export const ChatBubble: React.FC<ChatBubbleProps> = ({
  msg, msgIndex, isLast, onResend, onEdit, onSuggest, onTogglePin, onSaveItem, suggestions // ✅ Panggil isLast
}) => {
  const [copied, setCopied] = useState(false);
  ...
  return (
    <div id={`message-${msgIndex}`} className={cn("flex flex-col group w-full", isUser ? "items-end" : "items-start")}>
      ...
      {/* ✅ Logika isLast dipake di sini buat mastiin suggestion cuma muncul di chat paling bawah */}

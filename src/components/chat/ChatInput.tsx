...
const ModeSelectorPopup: React.FC<{
  ...
  <>
    <div className="fixed inset-0 z-[110] pointer-events-auto" onClick={onClose} />
    <div
      className={cn("absolute z-[120] bg-[var(--bg)] rounded-[32px] p-2 flex flex-col left-4 pointer-events-auto")}
      style={{ 
        width: 320, 
...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  const handleSend = () => {
    ...
    setIsFullscreenEditor(false); // Tutup juga modalnya pas ngirim
    if (textareaRef.current) textareaRef.current.style.height = 'auto';
  };

  // ✅ FULLSCREEN EDITOR MODAL (FIXED POINTER EVENTS)
    ...
    <AnimatePresence>
      {isFullscreenEditor && (
        <motion.div 
          ...
          // KUNCI PERBAIKAN: pointer-events-auto
  ...
  return (
    <>
      ...
      {/* KUNCI PERBAIKAN: pointer-events-auto ditambahin biar klik ke gambar gak tembus */}
      {lightboxUrl && (

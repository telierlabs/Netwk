    ...
    <>
      ...
      {compact ? (
        <div className="pointer-events-auto" style={{ width: '100%', position: 'relative' }}>
          ...
          {/* Untuk layar compact/sementara, kita tempel juga di dalam bg */}
              ...
              {replyingTo && (
                ...
                >
                  <div className="bg-[var(--bg)] rounded-xl border-l-[4px] border-[var(--ac)] p-2.5 pr-10 relative">
                    ...
                    <span className="text-[13px] text-[var(--text)]/80 line-clamp-1">
                      {replyingTo.content}
                    </span>
                  </div>
                </motion.div>
            ...
            {isListening && !showLiveVoice ? (
              ...
              <div className="flex items-center w-full" style={{ height: 54, paddingLeft: 20, paddingRight: 8, gap: 12 }}>
                <textarea
                  ...
                  rows={1}
                  autoFocus={false}
                  className="flex-1 bg-transparent border-none outline-none resize-none text-[14.5px] placeholder:text-[var(--mu)] text-[var(--text)]"
          ...
          <div className="max-w-3xl mx-auto">
            {isListening && !showLiveVoice ? (
              ...
              <div className="relative">
                {/* ✅ FIX: KOTAK PREVIEW NYATU SAMA INPUT (Bukan absolute lagi, tapi di dalam flex-col)
                  Ini bikin WA style persis. Preview pesan ada di atas textarea tapi masih dalem border yang sama.
                */}
                <div
                ...
                >
                    ...
                    {replyingTo && (
                      ...
                      >
                        ...
                        <div className="bg-[var(--bg)] rounded-[16px] border-l-[4px] border-[var(--ac)] p-3 pr-10 relative">
                          ...
                          <span className="text-[13.5px] text-[var(--text)]/80 line-clamp-2 font-medium leading-snug">
                            {replyingTo.content}
                          </span>
                        </div>
                      </motion.div>
                  ...
                  {/* PREVIEW ATTACHED FILES (Images/PDFs) */}

          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center">
              <img 
                ...
                alt="Cylen Logo" 
                className="w-7 h-7 object-contain" // 🔥 Ukuran presisi: sedikit lebih besar dari huruf C
              />
            </div>
            <span className="text-[20px] font-black text-[var(--text)] tracking-tighter leading-none">Cylen</span>
          </div>

        ...
        >
          ...
          <div className="flex-1 p-5 overflow-hidden bg-[var(--bg)] relative z-[305]">
            <textarea
              ...
              onPaste={handlePaste} 
              // ✅ FIX BUG OUTLINE ITEM: focus:ring-0 focus:outline-none
        ...
        <div className="max-w-4xl mx-auto w-full">
          {isListening && !showLiveVoice ? (
            ...
            <div className="relative w-full">
              ...
              <div
                className="rounded-[32px] flex flex-col relative outline-none ring-0 overflow-hidden transition-all duration-300 transform-gpu w-full"
                style={{
                  background: 'var(--sf)',
                  border: '1px solid var(--bd)',

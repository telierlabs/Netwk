...
const ModeSelectorPopup: React.FC<{
  ...
  onClose: () => void;
  above?: boolean; // true = muncul di atas tombol
}> = ({ current, onSelect, onClose, above = true }) => (
  <>
    {/* backdrop */}
...
const ModeButton: React.FC<{
  ...
  return (
    <button
      onClick={onClick}
      className="flex items-center gap-1.5 rounded-full font-medium transition-all hover:opacity-80"
      style={{
        ...
        <div style={{ width: '100%', position: 'relative' }}>
          ...
          >
            <button
              ...
              className={cn('flex-shrink-0 transition-all', isListening ? 'text-red-400' : 'text-[var(--mu)] hover:text-[var(--text)]')}
            >
              <Mic size={17} />
            </button>
            ...
            <div className="flex items-center gap-2 flex-shrink-0" style={{ position: 'relative' }}>
              ...
              <button
                ...
                className="text-[var(--mu)] hover:text-[var(--text)] transition-colors flex-shrink-0"
              >
              ...
              {hasContent && !isSending && (
                <button
                  onClick={handleSend}
                  className="w-8 h-8 rounded-full flex items-center justify-center bg-[var(--ac)] text-[var(--at)] transition-all hover:opacity-85 flex-shrink-0"
                >
          ...
          {showPicker && (
            <div
              className="absolute bottom-full mb-3 left-0 bg-[var(--bg)] border border-[var(--bd)] rounded-2xl p-2 flex gap-1 z-[100]"
    ...
    <>
      ...
      <footer className="px-4 pb-4 pt-2 bg-[var(--bg)] relative">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-[var(--bg)] rounded-3xl overflow-hidden" style={{ border: '1px solid var(--bd)' }}>
            {attachedFiles.length > 0 && (

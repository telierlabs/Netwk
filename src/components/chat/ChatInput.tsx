...
interface ChatInputProps {
  ...
  onUpgradeClick?: () => void; // 🔥 PROP UPGRADE
}
    ...
    >
      <div className="px-4 pt-4 pb-4 mb-2 flex items-center justify-between border-b border-[var(--bd)] border-opacity-60">
        <div className="flex flex-col">
          <div className="flex items-center gap-2 mb-0.5"><IconCylen /><span className="text-[17px] font-bold text-[var(--text)] tracking-tight">Cylen</span></div>
    ...
    <>
      ...
      {compact ? (
        ...
        <footer className="px-4 pb-4 pt-2 bg-[var(--bg)] relative z-50">
          {/* 🔥 PASSING PROP UPGRADE KE MODE SELECTOR POPUP */}

...
const ModeSelectorPopup: React.FC<{
  ...
  <>
    ...
    <div
      className={cn("absolute z-[120] bg-[var(--bg)] rounded-[32px] p-2 flex flex-col")}
      style={{ 
        // 🔥 KUNCI: left & right, bukan width fixed
        // left: mulai dari tepi footer (16px padding footer + 0 offset)
        // right: sisain ruang untuk mic (46px) + speak/send (~90px) + gap + padding kanan footer (12px) = ~115px
        left: 0,
        right: 270,

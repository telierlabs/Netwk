    ...
    <>
      ...
      >
        {panel === 'main' ? (
          <div className="flex flex-col">
            <div className="flex items-center justify-between px-3 pt-3 pb-3.5 mb-1 border-b border-[var(--text)]/10">
              <div className="flex items-center gap-2.5">
                <img
                  src="/IMG_20260427_105231.png"
                  alt="Cylen Logo"
                  className="w-7 h-7 object-contain"
                />

                <div className="flex flex-col">
                  <span className="text-[16px] font-bold text-[var(--text)] tracking-tight leading-none">
                    Cylen
                  </span>

                  <span className="text-[11px] text-[var(--mu)] font-medium mt-0.5">
                    Akses intelijen premium
                  </span>
                </div>
              </div>
            ...
            <label className="relative w-full flex items-center gap-3 px-3 py-[11px] rounded-[16px] text-[14.5px] font-semibold text-[var(--text)] cursor-pointer hover:bg-[var(--text)]/8 active:bg-[var(--text)]/8 [-webkit-tap-highlight-color:transparent]">
              ...
              <span className="flex-shrink-0 w-5 h-5 flex items-center justify-center opacity-85">
                <IconFile />
              </span>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ...
                      : 'text-[var(--text)] hover:bg-[var(--text)]/8 active:bg-[var(--text)]/8',
                  )}
                >
                  <span className="flex-shrink-0 w-5 h-5 flex items-center justify-center opacity-85">
                    <m.Icon />
            ...
            >
              <div className="flex flex-col items-start gap-[1px]">
                <span className="text-[10.5px] font-semibold uppercase tracking-wide text-[var(--mu)]">
                  Current Model
                </span>
          ...
          <div className="flex flex-col">
            <div className="text-center text-[15px] font-bold px-2 pt-2.5 pb-2 text-[var(--text)]">
              Choose AI Model
            </div>
              ...
              {AI_MODELS.map((name) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {selected && (
                        <span className="w-[7px] h-[7px] rounded-full bg-[var(--bg)]" />
                      )}
                    </span>
                    ...
                    {selected && (
                      <span className="ml-auto text-[var(--text)]/90">
                        <IconCheck />
                      </span>
                    )}
                  </button>
...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    // Reset dulu supaya scrollHeight membaca tinggi sebenarnya.
    ...
    const multiline = el.scrollHeight > singleLineHeight + 2;
    ...
    (files: File[]) => {
      ...
      Promise.all(
          ...
          (file) =>
            new Promise<AttachedFile>((resolve) => {
              ...
              reader.onloadend = () => {
                ...
                const type: AttachedFile['type'] = isPdf
                  ? 'pdf'
                  : isVideo
                    ? 'video'
                    : isImage
        ...
        setAttachedFiles((prev) => {
          ...
          setAttachedImage(
            next.find((f) => f.type === 'image')?.url || null,
          );
  ...
  const handlePaste = (
    ...
    if (pastedText.length > MAX_PASTE_LENGTH) {
      ...
      processFiles([
        new File([blob], 'Kode_Panjang.txt', {
          type: 'text/plain',
        }),
      ]);

      setInputText(
        (prev) => prev + ' [File kode dilampirkan]',
      );
    }
  };
        ...
        >
          <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--text)]/10 bg-[var(--bg)] shadow-sm z-[310]">
            <button
              ...
              className="p-2 -ml-2 text-[var(--text)]/60 hover:text-[var(--text)] transition-colors rounded-full active:scale-90 [-webkit-tap-highlight-color:transparent]"
            >
              <ArrowLeft
                size={22}
                strokeWidth={2.5}
            ...
            <span className="font-bold text-[16px] text-[var(--text)] tracking-tight">
              Edit Pesan
            </span>
            ...
            <div className="flex items-center">
              <button
                ...
                className="p-2 text-[var(--text)] rounded-full active:scale-90 mr-2 [-webkit-tap-highlight-color:transparent]"
              >
                <Trash2
                  size={22}
                  strokeWidth={2}
              ...
              <button
                ...
                className="p-2 -mr-2 text-[var(--text)]/60 rounded-full active:scale-90 [-webkit-tap-highlight-color:transparent]"
              >
                <X
                  size={22}
                  strokeWidth={2.5}
          ...
          <div className="flex-1 p-[18px] overflow-hidden bg-[var(--bg)] z-[305]">
            <textarea
              ...
              onPaste={handlePaste}
              className="w-full h-full bg-transparent border-none outline-none resize-none break-words text-[16px] leading-relaxed text-[var(--text)] placeholder:text-[var(--mu)] focus:ring-0 text-left"
              style={
                {
                  outline: 'none',
                  border: 'none',
  ...
  return (
    <>
      ...
      {lightboxUrl && (
        <div
          className="fixed inset-0 z-[200] bg-[#0a0a0a]/95 flex items-center justify-center p-4 pointer-events-auto"
        ...
        >
          ...
          <button
            type="button"
            className="absolute top-5 right-5 w-10 h-10 bg-[#ffffff]/10 rounded-full flex items-center justify-center text-[#ffffff]"
            onClick={(e) => {
              e.stopPropagation();
              setLightboxUrl(null);
            }}
        ...
        <div className="max-w-4xl mx-auto w-full">
          {isListening && !showLiveVoice ? (
            <div className="flex items-center justify-between w-full h-[64px] rounded-[26px] px-2 relative overflow-hidden bg-[var(--text)]/5 shadow-sm backdrop-blur-md border border-[var(--text)]/10">
              <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[220px] h-[50px] bg-[var(--text)]/20 blur-[20px] rounded-full animate-pulse"
                style={{
              ...
              <button
                ...
                className="relative z-10 w-[46px] h-[46px] rounded-full flex items-center justify-center bg-[var(--bg)] text-[var(--text)] active:scale-95 transition-transform shadow-sm [-webkit-tap-highlight-color:transparent]"
              >
                <X
                  size={20}
                  strokeWidth={2.5}
              ...
              <div className="relative z-10 flex-1 flex justify-center items-center px-4 overflow-hidden">
                {voiceText ? (
                  ...
                  <div className="flex items-center text-[var(--mu)] text-[13px] font-medium">
                    <span className="rotate-180 mr-1 opacity-50 flex">
                      <IconChevronRight />
                    </span>
                    Bicara sekarang...
                  </div>
              ...
              <button
                ...
                className="relative z-10 w-[46px] h-[46px] rounded-full flex items-center justify-center bg-[var(--text)] text-[var(--bg)] active:scale-95 transition-transform shadow-md [-webkit-tap-highlight-color:transparent]"
              >
                <IconArrowUp />
              </button>
            </div>
              ...
              >
                    ...
                    >
                      <div className="bg-[var(--bg)] rounded-[16px] border-l-[4px] border-[var(--text)] p-2.5 pr-9 relative">
                        <button
                          ...
                          className="absolute right-1.5 top-1.5 w-[26px] h-[26px] flex items-center justify-center text-[var(--mu)] rounded-full active:scale-90 [-webkit-tap-highlight-color:transparent]"
                        >
                          <X
                            size={15}
                            strokeWidth={2.5}
                        ...
                        <div className="text-[11px] font-bold text-[var(--text)] tracking-wide uppercase mb-1">
                          {replyingTo.role === 'user'
                            ? 'Kamu'
                            : 'Cylen AI'}
                        </div>

                        <span className="text-[13px] text-[var(--text)]/80 line-clamp-2 leading-snug break-words">
                          {replyingTo.content}
                        </span>
                      </div>
                    </motion.div>
                ...
                {attachedFiles.length > 0 && (
                  <div className="px-3.5 pt-3 pb-1">
                    <div
                      className="flex gap-2 overflow-x-auto pb-1 items-center"
                      style={{
                        scrollbarWidth: 'none',
                      }}
                    >
                      {attachedFiles.map((file) => {
                        if (
                          ...
                          return (
                            <div
                              key={file.id}
                              className={cn(
                                'relative flex-shrink-0 animate-in zoom-in duration-200 flex items-center gap-2 h-11 pl-1 pr-2 rounded-full max-w-[190px]',
                                isPdf
                                  ? 'bg-red-500/10'
                                  : 'bg-blue-500/10',
                              )}
                            >
                              ...
                              <span className="text-[12.5px] font-semibold truncate text-[var(--text)] max-w-[100px] leading-tight">
                                {file.name ||
                                  'Dokumen'}
                              </span>
                              ...
                              <button
                                ...
                                className="flex-shrink-0 w-5 h-5 rounded-full bg-[var(--text)]/10 flex items-center justify-center text-[var(--text)] [-webkit-tap-highlight-color:transparent]"
                              >
                                <X
                                  size={12}
                                  strokeWidth={2.5}
                        ...
                        return (
                          <div
                            key={file.id}
                            className="relative flex-shrink-0 animate-in zoom-in duration-200 h-11 w-[104px] rounded-full overflow-hidden bg-[var(--text)]/7 shadow-sm inline-flex"
                          >
                            {file.type === 'video' ? (
                              <div
                            ...
                            <button
                              ...
                              className="absolute top-[3px] right-[3px] w-5 h-5 bg-black/65 backdrop-blur-md text-white rounded-full flex items-center justify-center shadow-md z-10 [-webkit-tap-highlight-color:transparent]"
                            >
                              <X
                                size={11}
                                strokeWidth={3}
                ...
                >
                  ...
                  <textarea
                    ...
                    rows={1}
                    className={cn(
                      'absolute left-0 right-0 bottom-0 w-full bg-transparent border-none outline-none resize-none break-words text-[15.5px] leading-relaxed text-left placeholder:text-[var(--mu)] text-[var(--text)] focus:ring-0 focus:outline-none',
                      'overflow-x-hidden',
                      isMultiLine
                        ? 'pt-[10px] pb-[52px]'
                        : 'py-[9px]',
                  ...
                  <AnimatePresence>
                    {isMultiLine && (
                      <motion.button
                        ...
                        className="absolute top-[8px] right-[93px] w-7 h-7 flex items-center justify-center bg-[#141414]/70 backdrop-blur-sm border border-[var(--text)]/12 rounded-full text-[var(--text)] shadow-sm active:scale-95 z-20 [-webkit-tap-highlight-color:transparent]"
                      >
                        <Maximize2
                          size={14}
                          strokeWidth={2.5}
                  ...
                  <button
                    ...
                    className={cn(
                      'absolute left-2 bottom-1.5 z-30 w-10 h-10 rounded-full flex items-center justify-center transition-colors flex-shrink-0 [-webkit-tap-highlight-color:transparent]',
                      showAttachPopup
                        ? 'bg-[var(--text)]/12 text-[var(--text)]'
                        : isFull
                  ...
                  {/* ---------------------------------------------------- */}
                  {/* RIGHT CONTROLS — ALWAYS bottom-right                 */}
                  {/* ---------------------------------------------------- */}

                  <div className="absolute right-2 bottom-1.5 z-30 flex items-center gap-1.5">
                    {hasContent ? (
                      <>
                        <button
                          type="button"
                          ...
                          title="Hapus teks"
                          className="w-9 h-9 rounded-full flex items-center justify-center text-[var(--text)]/60 bg-[var(--text)]/5 active:scale-95 transition-transform [-webkit-tap-highlight-color:transparent]"
                        >
                          <Trash2 size={15} />
                        </button>
                      ...
                      <>
                        <button
                          ...
                          className="w-9 h-9 rounded-full flex items-center justify-center text-[var(--text)] bg-[var(--text)]/6 active:scale-95 transition-transform [-webkit-tap-highlight-color:transparent]"
                        >
                          <IconMic />
                        </button>

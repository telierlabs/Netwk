...
// 🔥 IKON ATTACHMENT BARU (Klip Kertas Berdiri Tegak Lurus)
const IconPaperclip = () => (
...
// 🔥 IKON GELOMBANG SUARA (Garis ditebelin & ditinggiin biar proporsional)
const IconSpeakWave = () => (
            ...
            <div className="bg-[var(--bg)] rounded-[32px] relative" style={{ border: '1px solid var(--bd)' }}>
              ...
              <div className="flex items-center justify-between px-3 pb-3 pt-2 relative">
                <div className="flex items-center gap-1">
                  {/* 🔥 TOMBOL ATTACHMENT JADI PAPERCLIP TEGAK LURUS */}

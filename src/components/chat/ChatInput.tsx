  ...
  <>
    ...
    >
      ...
      <div className="flex flex-col gap-0.5 pt-0.5">
        ...
        {/* 🔥 TOMBOL CANVAS BARU DI ATAS MODE AUTO */}
        <button
          onClick={() => {
            alert("Buka Halaman Canvas Mode!"); // Nanti ganti fungsinya buat buka rute Canvas lo
            onClose();
          }}
        ...
        >
          <div className="flex-shrink-0 mt-0.5 text-[var(--ac)] opacity-90 group-hover:opacity-100 group-hover:scale-110 transition-all">
            {/* Ikon Dashboard/Grid buat Canvas */}
        ...
        {/* ── LIST MODE CHAT BAWAAN (Auto, Spark, Think) ── */}
        {MODES.map((m) => {
              ...
              <div className="flex items-center justify-between px-3 pb-3 pt-2 relative">
                ...
                <div className="flex items-center gap-1.5 relative z-[105]">
                  ...
                  {hasContent ? (
                    ...
                    <button 
                      onClick={() => setShowLiveVoice(true)} 
                      className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-[var(--text)] text-[var(--bg)] transition-all hover:scale-105 shadow-md flex-shrink-0"
                    >
                      <IconSpeakWave />
                      <span className="text-[15px] font-bold tracking-wide">Speak</span>
                    </button>
                  )}
                </div>
              </div>

    ...
    <>
      ...
      <footer className="px-4 pb-4 pt-2 bg-[var(--bg)] relative">
        ...
        <div className="max-w-3xl mx-auto">
          {/* GANTI: bg-[var(--sf)] → bg-[var(--bg)], tambah border permanen */}
          <div className="bg-[var(--bg)] rounded-3xl border border-[var(--bd)] focus-within:border-[var(--ac)] transition-all shadow-sm overflow-hidden">

...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  // 🔥 STATE UNTUK GOD MODE (LIVE VOICE)
  const [showLiveVoice, setShowLiveVoice] = useState(false);

  // Fungsi Speech-to-Text (Ngubah suara jadi teks di input chat)
  ...
  return (
    <>
      {/* 🔥 OVERLAY LIVE VOICE MODE (GOD MODE) */}
        ...
        <div style={{ width: '100%', position: 'relative' }}>
          ...
          <div className="flex items-center w-full" style={{ height: 54, borderRadius: 999, border: '1px solid var(--bd)', background: 'var(--sf)', paddingLeft: 20, paddingRight: 8, gap: 12 }}>
            ...
            <div className="flex items-center gap-1.5 flex-shrink-0" style={{ position: 'relative' }}>
              ...
              {/* TOMBOL MIC (Speech to text biasa) - SELALU ADA JIKA KOSONG */}
              {!hasContent && (
              ...
              {/* 🔥 LOGIKA TOMBOL KANAN: SPEAK (LIVE VOICE) VS KIRIM TEKS */}
              {hasContent ? (
                ...
                <button 
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-full bg-[var(--text)] text-[var(--bg)] font-bold transition-all hover:scale-105 shadow-md flex-shrink-0 relative z-[105]"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path strokeLinecap="round" strokeLinejoin="round" d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="22"/></svg>
            ...
            <div className="bg-[var(--bg)] rounded-[32px] relative" style={{ border: '1px solid var(--bd)' }}>
              ...
              <div className="flex items-center justify-between px-3 pb-3 pt-2 relative">
                ...
                <div className="flex items-center gap-1.5 relative z-[105]">
                  ...
                  {/* 🔥 LOGIKA TOMBOL NORMAL MODE (KOSONG = SPEAK, ADA TEKS = KIRIM) */}
                  {hasContent ? (
                    ...
                    >
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path strokeLinecap="round" strokeLinejoin="round" d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="22"/></svg>

...
// 🔥 IKON GELOMBANG SUARA (Lebih lebar, garis tipis presisi ala Grok)
const IconSpeakWave = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex items-center gap-1.5 flex-shrink-0" style={{ position: 'relative' }}>
              ...
              {hasContent ? (
                ...
                <button 
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-[var(--text)] text-[var(--bg)] transition-all hover:scale-105 shadow-md flex-shrink-0 relative z-[105]"
                >
                  <IconSpeakWave />
                  {/* 🔥 Text "Speak" digedein biar proporsional */}
                  <span className="text-[14px] font-bold tracking-wide">Speak</span>
                </button>
              )}
            </div>
          </div>
              ...
              <div className="flex items-center justify-between px-3 pb-3 pt-2 relative">
                ...
                <div className="flex items-center gap-1.5 relative z-[105]">
                  ...
                  {hasContent ? (
                    ...
                    >
                      <IconSpeakWave />
                      {/* 🔥 Text "Speak" digedein biar tegas kaya Grok */}

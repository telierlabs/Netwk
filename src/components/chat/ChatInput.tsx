...
const ModeSelectorPopup: React.FC<{
  ...
  <>
    ...
    >
      {/* Cylen Header */}
      <div className="px-3 pt-2.5 pb-3.5 mb-1 flex items-center justify-between border-b border-[var(--bd)] border-opacity-60">
        ...
        {MODES.map((m) => {
          ...
          return (
            <button
              ...
              className="w-full flex items-start gap-3.5 px-3 py-2.5 rounded-[20px] transition-all text-left"
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[14px] font-bold leading-tight mb-0.5" style={{ color: 'var(--text)' }}>{m.label}</div>

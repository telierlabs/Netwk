...
import { Mic, Zap, ChevronRight, X, Square } from 'lucide-react';
...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    <>
      ...
      {/* VOICE OVERLAY */}
      {isListening && (
        <div className="fixed inset-0 z-[180] bg-black/60 flex flex-col items-center justify-center gap-6"
          ...
          <div className="flex flex-col items-center gap-4" onClick={e => e.stopPropagation()}>
            ...
            <div className="relative w-24 h-24 flex items-center justify-center">
              ...
              <button onClick={stopListening}
                className="relative w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-2xl active:scale-95 transition-transform">
            ...
            <div className="flex items-center gap-1.5 h-10">
              {[4,8,14,20,28,22,16,10,6,12,20,14,8,4].map((h, i) => (
                <div key={i} style={{
                  ...
                  borderRadius: 99,
                  background: 'white',
                  animation: `neuralWave 0.8s ease-in-out infinite`,
            ...
            <div className="max-w-xs text-center">
              {voiceText ? (
                <p className="text-white text-base font-medium px-4">{voiceText}</p>
              ) : (
                <p className="text-white/50 text-sm">Sedang mendengarkan...</p>
              )}
            </div>
      ...
      <footer className="px-4 pb-4 pt-2 bg-[var(--bg)] relative">
        ...
        {/* PICKER POPUP */}
        {showPicker && (
          <div className="absolute bottom-full mb-2 left-4 bg-[var(--bg)] rounded-2xl p-2 flex gap-1 z-[100]"

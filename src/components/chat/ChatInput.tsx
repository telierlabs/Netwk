    ...
    <AnimatePresence>
      {isFullscreenEditor && (
        <motion.div 
          ...
          className="fixed inset-0 z-[300] bg-[var(--bg)] flex flex-col pointer-events-auto outline-none"
        >
        ...
        <div className="max-w-4xl mx-auto w-full outline-none">
          {isListening && !showLiveVoice ? (
            ...
            <div className="relative w-full outline-none">
              ...
              {/* ✅ KUNCI PERBAIKAN: Outline diilangin paksa, [-webkit-tap-highlight-color:transparent] ditambahin */}
              <div
                className="rounded-[32px] flex flex-col relative overflow-hidden transition-all duration-300 transform-gpu w-full focus:outline-none focus:ring-0 outline-none [-webkit-tap-highlight-color:transparent]"
                style={{
                  background: 'var(--sf)',
                  border: '1px solid var(--bd)',
              ...
              >
                ...
                <div className="px-5 pt-4 pb-1 relative z-[105] flex outline-none">
                  ...
                  <textarea
                    ...
                    rows={1}
                    className="w-full bg-transparent border-none outline-none resize-none text-[16px] leading-relaxed placeholder:text-[var(--mu)] text-[var(--text)] min-h-[28px] max-h-40 relative z-[105] py-1 focus:ring-0 focus:outline-none focus:border-transparent [-webkit-tap-highlight-color:transparent]" 
                      ...
                      {hasContent && (
                        ...
                        >
                          <button
                            ...
                            title="Hapus Teks"
                            className="p-2 text-[var(--text)] hover:text-red-500 transition-colors rounded-full flex-shrink-0 outline-none [-webkit-tap-highlight-color:transparent]"
                          >
                          ...
                          {showMaximize && (
                            <button
                              ...
                              title="Perbesar"
                              className="p-2 text-[var(--mu)] hover:text-[var(--text)] hover:bg-[var(--text)]/10 transition-colors rounded-full flex-shrink-0 outline-none [-webkit-tap-highlight-color:transparent]"
                            >

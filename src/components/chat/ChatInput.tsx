...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    <>
      ...
      {/* ⚠️ FULL-SCREEN OVERLAY HITAM UDAH DIBUANG DARI SINI! ⚠️ */}
      ...
      {compact ? (
        <div style={{ width: '100%', position: 'relative' }}>
          ...
          {/* 🔥 INLINE AUDIO RECORDER ALA GROK (COMPACT MODE) */}
        ...
        <footer className="px-4 pb-4 pt-2 bg-[var(--bg)] relative z-50">
          ...
          <div className="max-w-3xl mx-auto">
            {/* 🔥 INLINE AUDIO RECORDER ALA GROK (FOOTER MODE) */}
            {isListening && !showLiveVoice ? (

      ...
      {compact ? (
        <div className="pointer-events-auto" style={{ width: '100%', position: 'relative' }}>
          ...
          {isListening && !showLiveVoice ? (
            <div className="flex items-center justify-between w-full h-[54px] rounded-full px-1.5 relative overflow-hidden bg-[var(--sf)] shadow-sm" style={{ border: 'none' }}>
            ...
            <div className="flex items-center w-full" style={{ height: 54, borderRadius: 999, border: 'none', background: 'var(--sf)', paddingLeft: 20, paddingRight: 8, gap: 12 }}>
        ...
        <footer className="px-4 pb-6 pt-2 relative z-50 pointer-events-auto">
          ...
          <div className="max-w-3xl mx-auto">
            {isListening && !showLiveVoice ? (
              <div className="flex items-center justify-between w-full h-[64px] rounded-[32px] px-2 relative overflow-hidden bg-[var(--sf)] shadow-sm transition-all duration-300" style={{ border: 'none' }}>
              ...
              <div className="bg-[var(--bg)] rounded-[32px] relative transition-all shadow-[0_8px_24px_rgba(0,0,0,0.12)]" style={{ border: 'none' }}>

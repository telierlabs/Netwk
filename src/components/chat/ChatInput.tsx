          ...
          {isListening && !showLiveVoice ? (
            ...
            <div className="relative w-full">
              ...
              <motion.div
                ...
                className="rounded-[26px] flex flex-col relative overflow-hidden bg-[var(--text)]/[0.06] border border-[var(--text)]/10 shadow-[0_4px_24px_rgba(0,0,0,0.25)] backdrop-blur-md"

...
const ModeSelectorPopup: React.FC<{
  ...
  <>
    ...
    {/* 🔥 POPUP DIBUAT RESPONSIVE, jarak aman kiri-kanan (max-w-[calc(100vw-32px)]) */}
    <div
      className={cn("absolute z-[120] bg-[var(--bg)] rounded-[32px] p-2 flex flex-col left-4")}
      style={{ 
        width: 320, 
        maxWidth: 'calc(100vw - 32px)', // Jarak aman biar nggak motong layar HP
      ...
      <div className="px-5 pt-6 pb-5 mb-2 flex items-center justify-between border-b border-[var(--bd)] border-opacity-60">
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-3">
            {/* 🔥 IKON MURNI TANPA BACKGROUND, UKURAN GEDE */}
            <img 
              src="/IMG_20260427_105231.png" 
              alt="Cylen Logo" 
              className="w-10 h-10 object-contain" // Di-gede-in w-10 h-10
            />
            {/* 🔥 FONT CYLEN TEBAL */}
        ...
        <button 
          ...
          className="bg-[var(--text)] text-[var(--bg)] px-5 py-2.5 rounded-full text-[14px] font-bold shadow-md hover:scale-105 active:scale-95 transition-all tracking-wide flex-shrink-0"
        >
          Upgrade
        </button>
      </div>
    ...
    <>
      ...
      {compact ? (
        ...
        <footer className="px-4 pb-4 pt-2 bg-[var(--bg)] relative z-50">
          {/* 🔥 POPUP MANGGIL DENGAN JARAK AMAN */}

...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  // ─────────────────────────────────────────────
  // COMPACT MODE — pill shape, panjang, tipis kaya Grok
  // ─────────────────────────────────────────────
  if (compact) {
    return (
      <>
        ...
        <div style={{ width: '100%', position: 'relative' }}>
          ...
          {/* ── PILL INPUT — panjang, height 52px, rounded-full ── */}
          <div
          ...
          >
            ...
            <button
              ...
              className={cn(
                ...
                isListening ? 'text-red-400' : 'text-[var(--mu)] hover:text-[var(--text)]'
              )}
              title="Voice input"
            >
              <Mic size={17} />
            ...
            {/* Kanan: Auto pill + warning icon + send */}
            <div className="flex items-center gap-2 flex-shrink-0">
              {/* Auto */}
              <button
                className="flex items-center gap-1 px-3 py-1.5 rounded-full text-[12px] font-medium text-[var(--mu)] hover:text-[var(--text)] transition-all"
              ...
              {/* Warning icon (dekoratif, kaya Grok) */}
              <button
              ...
              {/* Send button — hanya muncul jika ada konten */}

...
// 🔥 FIX: Ikon Rocket di-import dari lucide-react buat gantiin ikon 'Auto' lama
...
// 🔥 FIX: Ikon Auto diganti jadi Roket bawaan Lucide, biar futuristik!
...
// Pake Paperclip lucide standar biar konsisten
  ...
  <>
    ...
    <div
      ...
      style={{ 
        ...
        // Samain border alertnya pake abu kaca blur
    ...
    >
      ...
      <div className="flex flex-col gap-1 pt-1 pb-1 outline-none">
        {MODES.map((m) => {
          ...
          return (
            // Warna highlight popup disamain abu kaca blur
  ...
  return (
    <button
      ...
      className={cn(
        ...
        // 🔥 FIX: Tombol auto disamain warnanya jadi Abu Kaca Blur (bg-[var(--text)]/5) biar gak keputihan sendiri
              ...
              >
                ...
                <div className="flex items-center justify-between px-2 pb-2 pt-1 relative outline-none">
                  <div className="flex items-center gap-1.5 outline-none pl-1">
                    {/* 🔥 FIX: Tombol Attachment dikasih bubble abu kaca (bg-[var(--text)]/5) */}
                    <button
                  ...
                  <div className="flex items-center gap-1.5 relative z-[105] pr-1 outline-none">
                    {!hasContent && (
                      // 🔥 FIX: Tombol Microphone dikasih bubble abu kaca (bg-[var(--text)]/5)
                      <button onClick={startListening} className="p-2.5 rounded-full text-[var(--text)] bg-[var(--text)]/5 hover:bg-[var(--text)]/1

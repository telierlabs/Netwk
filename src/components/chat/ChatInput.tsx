      ...
      <footer className={cn("px-2 pb-6 relative z-50 pointer-events-auto w-full", compact ? "pt-0" : "pt-2")}>
        ...
        {showPicker && (
          <div
            ...
            style={{ width: 190 }}
          >
            {/* ✅ FIX ABSOLUT: Input tersembunyi berukuran 100% dari box, menimpa elemen visual. */}
            {/* User secara harfiah mencet input aslinya. Anti gagal. */}
            <div className={cn("w-full flex items-center gap-4 px-4 py-3.5 rounded-[20px] transition-colors text-[var(--text)] text-left relative overflow-hidden", isFull ? "opacity-40" : "hover:bg-[var(--text)]/5 active:bg-[var(--text)]/10")}>
              <input type="file" accept="image/*" capture="environment" onChange={handleFileChange} disabled={isFull} className="absolute inset-0 w-full h-full opacity-0 z-10 cursor-pointer" style={{ WebkitAppearance: 'auto' } as any} />
              <svg width="22" height="22" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" className="flex-shrink-0 opacity-80 relative z-0 pointer-events-none"><path strokeLinecap="round" strokeLinejoin="round" d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/></svg>
              <span className="text-[15px] font-semibold relative z-0 pointer-events-none">Kamera</span>
            </div>

            <div className={cn("w-full flex items-center gap-4 px-4 py-3.5 rounded-[20px] transition-colors text-[var(--text)] text-left relative overflow-hidden", isFull ? "opacity-40" : "hover:bg-[var(--text)]/5 active:bg-[var(--text)]/10")}>
              <input type="file" accept="image/*,video/*" multiple onChange={handleFileChange} disabled={isFull} className="absolute inset-0 w-full h-full opacity-0 z-10 cursor-pointer" style={{ WebkitAppearance: 'auto' } as any} />
              <svg width="22" height="22" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" className="flex-shrink-0 opacity-80 relative z-0 pointer-events-none"><rect x="3" y="3" width="18" height="18" rx="3"/><circle cx="8.5" cy="8.5" r="1.5"/><path strokeLinecap="round" strokeLinejoin="round" d="M21 15l-5-5L5 21"/></svg>
              <span className="text-[15px] font-semibold relative z-0 pointer-events-none">Galeri</span>
            </div>

            <div className={cn("w-full flex items-center gap-4 px-4 py-3.5 rounded-[20px] transition-colors text-[var(--text)] text-left relative overflow-hidden", isFull ? "opacity-40" : "hover:bg-[var(--text)]/5 active:bg-[var(--text)]/10")}>
              <input type="file" accept=".pdf,.txt,.doc,.docx,application/pdf,text/plain" multiple onChange={handleFileChange} disabled={isFull} className="absolute inset-0 w-full h-full opacity-0 z-10 cursor-pointer" style={{ WebkitAppearance: 'auto' } as any} />
              <svg width="22" height="22" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" className="flex-shrink-0 opacity-80 relative z-0 pointer-events-none"><path strokeLinecap="round" strokeLinejoin="round" d="M13 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V9z"/><path strokeLinecap="round" strokeLinejoin="round" d="M13 2v7h7"/></svg>
              <span className="text-[15px] font-semibold relative z-0 pointer-events-none">Dokumen</span>
            </div>
          </div>
        )}

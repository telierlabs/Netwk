...
const ModeSelectorPopup: React.FC<{
  ...
  <>
    ...
    <div
      className={cn("absolute z-[120] bg-[var(--bg)] rounded-[32px] p-1.5 flex flex-col left-4")}
      style={{ 
        width: 260, // 🔥 POPUP DIPERKECIL BIAR NGGAK NABRAK MIKROFON
    ...
    >
      <div className="px-3 pt-5 pb-5 mb-1 flex items-center justify-between border-b border-[var(--bd)] border-opacity-60">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center -ml-2">
              <img 
                ...
                alt="Cylen Logo" 
                className="w-16 h-16 object-contain scale-[1.4]" // 🔥 LOGO BULAN SUPER GEDE
              />
            </div>
            <span className="text-[24px] font-black text-[var(--text)] tracking-tighter leading-none -ml-1">Cylen</span>
          </div>
        ...
        <button 
          ...
          className="bg-[var(--text)] text-[var(--bg)] px-4 py-2.5 rounded-full text-[13px] font-black shadow-md hover:scale-105 active:scale-95 transition-all flex-shrink-0"
        >
          Upgrade
        </button>
      </div>
      ...
      <div className="flex flex-col pt-1 pb-1">
        <button onClick={() => { if (onOpenCanvas) onOpenCanvas(); onClose(); }} className="w-full flex items-center gap-3 px-4 py-3 rounded-[20px] transition-all text-left hover:bg-[var(--sf)] group" style={{ background: isCanvasActive ? 'var(--sf)' : 'transparent' }}>
          ...
          <div className="flex-1 min-w-0"><div className="text-[15px] font-bold leading-tight mb-0.5 text-[var(--text)]">Cylen Canvas</div><div className="text-[12px] leading-tight text-[var(--mu)]">Infinite workspace</div></div>

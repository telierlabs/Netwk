...
// PERUBAHAN (fix warna dark/light):
//   • DIHAPUS: <style> yang kemarin di-inject pakai
//     `prefers-color-scheme: dark`. Itu ngikutin dark mode
//     OS/browser, BUKAN toggle light/dark punya app Cylen sendiri
//     — makanya kemarin muncul bug bubble tetep gelap padahal
//     app-nya lagi di-set Light (OS masih dark).
//   • GANTI: background pakai color-mix() yang narik warna dari
//     var(--text) & var(--bg) milik app itu sendiri. Apapun cara
//     app togglenya (class, data-attribute, state React, dll),
//     var(--text)/var(--bg) itu udah pasti akurat mengikuti tema
//     app yang beneran aktif (bukan tebakan dari OS), jadi bubble
//     otomatis ikut, dan di dark mode hasilnya abu (bukan item legam
//     kaya var(--sf) lama).
// ─────────────────────────────────────────────

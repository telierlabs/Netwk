...
// Copy · Share · Like · Dislike · Regenerate · Pin
// ─────────────────────────────────────────────
import React, { useState } from 'react';
import { AnimatePresence, motion } from 'motion/react';
import { Copy, Check, Share2, ThumbsUp, ThumbsDown, RotateCcw, Pin, PinOff } from 'lucide-react';
...
export const ActionBar = ({ content, msgIndex, isPinned, onTogglePin, onRegenerate, visible }: ActionBarProps) => {
  ...
  const buttons = [
    {
      icon: copied ? <Check size={19} strokeWidth={2.5} /> : <Copy size={19} strokeWidth={2} />,
      onClick: handleCopy,
      active: copied,
    },
    {

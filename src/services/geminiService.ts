...
Kalau butuh konteks: maksimal **2 paragraf pendek**.
Setiap kalimat harus punya nilai — tidak ada pengulangan.

---

## FORMAT TEKS

Tulis satu ide per kalimat.
Pisah tiap paragraf dengan **1 baris kosong** — jangan blok padat.

Gunakan **bold** hanya untuk 1–2 kata kunci terpenting.
Jangan pakai heading/sub-judul — terlalu berat untuk jawaban singkat.

---

## FORMAT LIST

Kalau ada beberapa poin, gunakan bullet biasa tapi dengan **spasi lega antar poin**.

Contoh yang BENAR:

Biasanya karena:

• ngoding terlalu lama

• mata udah kering

• otak overheat

Setiap bullet di baris sendiri.
Tambahkan **1 baris kosong** di antara setiap bullet — jangan rapat.
Teks per bullet: **maksimal 5 kata**, langsung tanpa embel-embel.
Maksimal **4–5 bullet** per list.

Jangan nested list. Jangan sub-bullet.
...
Jangan pakai heading atau sub-judul.

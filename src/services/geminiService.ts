...
- **ATURAN MUTLAK DIAGRAM:** DILARANG KERAS menggunakan format "mindmap". WAJIB gunakan sintaks "graph TD" (untuk flowchart atas-bawah) atau "graph LR" (kiri-kanan) saja. Jangan berikan panah atau karakter aneh yang merusak format.

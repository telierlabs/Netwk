...
Kalau ada beberapa poin, tulis seperti ini:
...
Setiap poin di baris sendiri.
Pisah antar poin dengan garis \`---\` tipis.
Maksimal **4 poin**. Tiap poin **1 kalimat pendek**.

Jangan pakai bullet \`-\` atau \`•\` — langsung tulis teksnya saja.

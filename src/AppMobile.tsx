...
import { SubscriptionModal } from './components/paywall/SubscriptionModal'; // 🔥 IMPORT MODAL UPGRADE
...
export default function AppMobile() {
  ...
  const [isSubscriptionOpen, setIsSubscriptionOpen] = useState(false); // 🔥 STATE UPGRADE MODAL
  ...
  return (
    <div className={cn('app transition-colors duration-350', theme)} style={{ fontFamily: currentFontFamily, height: '100dvh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      {/* 🔥 SUBSCRIPTION MODAL (Hal Langganan Premium) */}
      <SubscriptionModal 
      ...
      {/* 🔥 SEMBUNYIKAN HEADER JIKA VIEW ADALAH TASKS */}
      ...
      <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        {view === 'chat' && (
          <ChatPage
            ...
            onUpgradeClick={() => setIsSubscriptionOpen(true)} // 🔥 KONEKSI SAKLAR UPGRADE
          />
        )}

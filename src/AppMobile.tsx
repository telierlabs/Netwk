...
export default function AppMobile() {
  ...
  // ✅ FUNGSI BACK UTAMA: Menangani routing kembali ke halaman sebelumnya dengan benar
  ...
  return (
    <div className={cn('app transition-colors duration-350', theme)} style={{ fontFamily: currentFontFamily, position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, width: '100vw', height: '100dvh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      {/* ✅ HEADER DIMUNCULKAN JIKA BUKAN SEARCH, TASKS, ATAU HALAMAN ANAK PROFILE */}
      {view !== 'search' && view !== 'tasks' && view !== 'appearance' && view !== 'usage' && view !== 'integrations' && view !== 'security' && view !== 'export' && (
        <Header 
          view={view as any} 
          onMenuClick={() => setIsSidebarOpen(true)} 
          onBackClick={handleBackClick} // Panggil fungsi yang bener
      ...
      <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        {/* Hal-hal Settings dilempar properti onBack-nya dengan bener */}
        ...
        {/* ✅ Rute untuk Group, pastikan prop onBack dipanggil ke GroupList / Chat */}
        ...
        {view === 'group-chat' && activeGroup && <GroupChatPage activeGroup={activeGroup} isSending={isGroupSending} onSendMessage={sendGroupMessage} onAddParticipant={addParticipant} showToast={showToast} onBack={() => setView('group-list')} />}
      </div>

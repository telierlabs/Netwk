...
export default function AppMobile() {
  ...
  // ── FIX: ngambil thinkingAI dari useGroupChat ──
  const { activeGroup, groupSessions, setActiveGroupId, isSending: isGroupSending, thinkingAI, createGroup, addParticipant, sendGroupMessage } = useGroupChat();
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        {/* ── FIX: PASSING PROPS thinkingAI KE GroupChatPage ── */}

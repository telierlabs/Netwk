...
export default function AppMobile() {
  ...
  return (
    <div className={cn('app', theme)} style={{ fontFamily: currentFontFamily, position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, width: '100vw', height: '100dvh', display: 'flex', flexDirection: 'column', overflow: 'clip', backgroundColor: 'var(--bg)' }}>
      ...
      {/*
        FILLER SAFE-AREA BAWAH
        Nutup total strip warna sistem (gesture bar Android/MIUI) yang suka
        nembus di bawah UI PWA. Warnanya otomatis ngikut var(--bg) sesuai
        tema aktif (light/dark), jadi nyatu sama background app, bukan
        keliatan sebagai garis/strip beda warna (cream, dsb).
      */}
      <div
        style={{
          position: 'fixed',

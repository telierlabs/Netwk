...
export default function AppMobile() {
  ...
  return (
    ...
    >
      <style>{`
        html, body, #root { background-color: var(--bg) !important; margin: 0 !important; padding: 0 !important; border: none !important; outline: none !important; box-shadow: none !important; }
      `}</style>

...
export default function AppMobile() {
  ...
  // Blank loading — tanpa teks apapun
  if (isAuthLoading) {
  ...
  return (
    <div className={cn('app', theme)} style={{ fontFamily: currentFontFamily, position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, width: '100vw', height: '100dvh', display: 'flex', flexDirection: 'column', overflow: 'hidden', backgroundColor: 'var(--bg)' }}>

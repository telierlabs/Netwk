...
export default function AppMobile() {
  ...
  // ── FIX: TAHAN RENDER AWAL BIAR GAK GLITCH ──
  ...
  // ── FIX: LOGIKA ROUTING URL BUAT MOBILE ──
  useEffect(() => {
    ...
    const checkRoute = async () => {
      ...
      if (path.startsWith('/join/')) {
        ...
        if (groupId) {
          ...
          if (result.success) {
            ...
            setView('group-chat'); // Langsung tembak ke grup
      ...
      // Kasih jeda dikit biar state view sempet ke-set sebelum ngelepas loading
  ...
  // ── FIX: TAHAN LAYAR KOSONG SAMPAI ROUTING BERES ──

...
export default function AppMobile() {
  ...
  return (
    // 🔥 TAMBAH fixed inset-0 w-full DI SINI BIAR KEKUNCI FULL SCREEN
    <div className={cn('app transition-colors duration-350 fixed inset-0 w-full', theme)} style={{ fontFamily: currentFontFamily, height: '100dvh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      <style>{`
        /* 🔥 KUNCI SCROLL BAWAAN OS DISINI */
        html, body {
          margin: 0; padding: 0;
          width: 100%; height: 100%;
          overflow: hidden !important;
          overscroll-behavior: none; /* Cegah bounce iOS */
        }
        #root {
          width: 100%; height: 100%;

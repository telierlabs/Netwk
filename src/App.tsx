...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* header sembunyikan di search view */}
      {view !== 'search' && (
        <Header
          view={view}
      ...
      <div style={{ flex:1, minHeight:0, display:'flex', flexDirection:'column', overflow:'hidden' }}>
        ...
        {view === 'chat' && (
          <ChatPage
            ...
            // 👇 INI YANG BARU: Ngirim fungsi saveItem & toast
            onSaveItem={(item) => { saveItem(item); showToast('Pesan berhasil disimpan!'); }} 
          />
        )}
        ...
        {view === 'saved' && <SavedPage savedItems={savedItems} onDelete={deleteItem}/>}

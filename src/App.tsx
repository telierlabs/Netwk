...
export default function App() {
  ...
  return (
    <div className={cn("app h-screen max-h-screen flex flex-col overflow-hidden transition-colors duration-350", theme)} style={{ fontFamily: currentFontFamily }}>
      <style>{`
          ...
          <GroupListPage 
            ...
            onCreateGroup={(title) => {
              ...
              if (id) {
                ...
                showToast('Maksimal 5 grup tercapai');
              }
            }}
          />
        )}

...
export default function App() {
  ...
  const {
    ...
    sendMessage, createNewChat, // <-- createTempChat dihapus dari sini (udah gak dipake di useChat.ts)
  ...
  // ✅ PERBAIKAN: Ganti pemanggilan createTempChat() jadi createNewChat(true) sesuai useChat.ts yang baru

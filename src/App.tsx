...
export default function App() {
  ...
  if (isAuthLoading) {
    return <div style={{ height: '100vh', width: '100vw', backgroundColor: '#010101' }} />;
  }

  // JIKA BELUM LOGIN: Render Landing Page Normal
  if (!user) {
    return (
      <div style={{
        ...
        <img src="/82374-removebg-preview.png" alt="Cylen" style={{ width: 80, height: 80, marginBottom: 24 }} />
        <h1 style={{ fontSize: '36px', fontWeight: 700, letterSpacing: '-1px', margin: '0 0 8px 0' }}>CYLEN</h1>
        <p style={{ color: '#666', fontSize: '14px', marginBottom: '32px', textAlign: 'center', maxWidth: '320px' }}>
          The Minimalist Cyberpunk Ecosystem.
        </p>
        <button
  ...
  // JIKA SUDAH LOGIN TAPI BELUM ADA IZIN: Hadang pakai Permission Page
  if (needsPermission) {
    return (

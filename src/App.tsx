...
export default function App() {
  ...
  return (
    ...
    >
        ...
        {view !== 'search' && (
          <div className="md:hidden">
            <Header
              ...
              isCanvasActive={isCanvasActive} // 🔥 TERUSKAN PROP KE HEADER APP GLOBAL
            />
          </div>
        )}
        ...
        <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          {view === 'chat' && (
            <ChatPage
              ...
              isCanvasActive={isCanvasActive} // 🔥 TERUSKAN PROP KE CHATPAGE
      ...
      <AnimatePresence>
        {toast && (
          <motion.div initial={{opacity:0,y:20,x:'-50%'}} animate={{opacity:1,y:0,x:'-50%'}} exit={{opacity:0,y:20,x:'-50%'}} className="fixed bottom-24 left-1/2 bg-[var(--ac)] text-[var(--at)] px-6 py-2.5 rounded-full text-sm font-medium shadow-2xl z-[100] whitespace-nowrap">
            {toast}
          </motion.div>
        )}
      </AnimatePresence>
